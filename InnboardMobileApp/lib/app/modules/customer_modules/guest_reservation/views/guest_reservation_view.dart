...
class GuestReservationView extends GetView<GuestReservationController> {
  GuestReservationView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var screenHeight = MediaQuery.of(context).size.height;

    return GetBuilder<GuestReservationController>(builder: (_) {
      return Scaffold(
