                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Text("Discount: ",
                                        style: Theme.of(context)
                                            ...
                                            .labelLarge),
                                    Obx(() => Text(
                                        "${controller.selectedType.value?.roomDiscountPercent}%",
                                        style: Theme.of(context)
                                            .textTheme
                                            .labelLarge)),
                                  ],
                                ...
                                Obx(() => Visibility(
                                      visible:
                                          controller.itemExtaBedAmount.value >
                                              0,
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                ...
                                // Text(
                                //   "*Note: Your available room night ${controller.selectedType.value?.availableRoomNight}",
