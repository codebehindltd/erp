...
class StalmentPaymentCard extends StatelessWidget {
  ...
  const StalmentPaymentCard(
      {super.key, this.stalmentTitle, this.paymentStStep, required this.paySubmit});
                ...
                children: [
                   Row(
                    ...
                    children: [
                      Icon(
                        Icons.done_all,
                        color:paymentStStep!.isPaid! == true ? Colors.green:Colors.grey,
                        size: 28.0,
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Text("${paymentStStep!.amount?.toStringAsFixed(2)} BDT", style: commonTextStyle()),
                    ],
                  ),
                  const SizedBox(
                    height: 16,
