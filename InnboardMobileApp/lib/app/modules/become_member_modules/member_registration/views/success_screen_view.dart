...
class SuccessScreenView extends GetView<MemberRegistrationController> {
  const SuccessScreenView({Key? key}) : super(key: key);
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            CustomButton(
                submit: (value) {
                  Get.offAllNamed(Routes.userTypeSelection);
                },
                name: "Continue",
                fullWidth: true,
