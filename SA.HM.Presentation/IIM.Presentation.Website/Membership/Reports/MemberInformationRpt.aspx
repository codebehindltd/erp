<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="MemberInformationRpt.aspx.cs" Inherits="HotelManagement.Presentation.Website.Membership.Reports.MemberInformationRpt" %>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlMember" runat="server" CssClass="form-control" TabIndex="6">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row">
