<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmMemberBillPayment.aspx.cs" Inherits="HotelManagement.Presentation.Website.Membership.frmMemberBillPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function OnFillFormObjectSucceeded(result) {
            $("#<%=hfCurrencyType.ClientID %>").val(result.CurrencyType);
            $("#<%=hfMemberPaymentId.ClientID %>").val(result.MemberPaymentId);
            MessagePanelHide();
            if ($("#<%=hfCurrencyType.ClientID %>").val() != "Local") {
                $('#ConversionPanel').show();
        ...
        function PerformClearAction() {
            ...
            $("#<%=hfMemberPaymentId.ClientID %>").val('');
        ...
        function PaymentPreview() {
            ...
            if (paymentIdList != "") {
                var url = "/Membership/Reports/frmReportMemberPayment.aspx?PaymentIdList=" + paymentIdList;
                var popup_window = "Preview";
                window.open(url, popup_window, "width=820,height=780,left=300,top=50,location=no,toolbar=no,menubar=no,resizable=yes, scrollbars=1");
            }
            else {
    ...
    <asp:HiddenField ID="hfMemberPaymentId" runat="server" />
    ...
    <div id="DivPaymentSelect" style="display: none;">
        <div id="Div1" class="panel-body">
            ...
            <asp:GridView ID="gvPaymentInfo" Width="100%" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="IDNO" ItemStyle-CssClass="ShowHide" HeaderStyle-CssClass="ShowHide">
                        <ItemTemplate>
                            <asp:Label ID="lblid" runat="server" Text='<%#Eval("MemberPaymentId") %>'></asp:Label></ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:Button ID="btnPaymentPreview" runat="server" Text="Preview" TabIndex="3" CssClass="TransactionalButton btn btn-primary btn-sm"
                OnClientClick="javascript: return PaymentPreview();" />
        </div>
    </div>
    <div id="btnNewBIll" class="btn-toolbar" style="display: none;">
        <button onclick="javascript: return EntryPanelVisibleTrue();" class="btn btn-primary btn-sm">
        ...
        <div id="tab-1">
            <div id="EntryPanel" class="panel panel-default">
                <div class="panel-heading">
                    Member Bill Payment Information</div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2" style="padding-right: 0;">
                                <asp:TextBox ID="txtSrcMemberId" runat="server" CssClass="form-control" TabIndex="1"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <asp:Button ID="btnSrcMemberId" runat="server" Text="Search" TabIndex="2" CssClass="TransactionalButton btn btn-primary btn-sm"
                                    OnClick="btnSrcMember_Click" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2">
                                <asp:Label ID="lblMemberName" runat="server" class="control-label" Text="Member Name"></asp:Label>
                            </div>
                            <div class="col-md-10">
                                <asp:TextBox ID="txtMemberName" CssClass="form-control" runat="server" TabIndex="11"
                        ...
                        <asp:GridView ID="gvGuestHouseService" Width="100%" runat="server" AllowPaging="True"
                            ...
                            <%--<asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="False" CommandName="CmdDelete"
                                ImageUrl="~/Images/delete.png" Text="" AlternateText="Delete" ToolTip="Delete" />--%>
                                        <asp:ImageButton ID="ImgPaymentPreview" runat="server" CausesValidation="False" CommandArgument='<%# bind("MemberPaymentId") %>'
