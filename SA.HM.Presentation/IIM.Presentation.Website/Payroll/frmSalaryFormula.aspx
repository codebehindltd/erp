<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="frmSalaryFormula.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.frmSalaryFormula" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#ContentPlaceHolder1_ddlSearchGrade").select2({
                tags: "true",
                placeholder: "--- Please Select ---",
                allowClear: true,
                width: "99.75%"
            ...
            $("#ContentPlaceHolder1_ddlSearchSelaryHead").select2({
                tags: "true",
                placeholder: "--- Please Select ---",
                allowClear: true,
                width: "99.75%"
            ...
            var companyName = $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLCompany").text();
            var projectId = 0;
            var projectName = $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLProject").text();
            $("#<%=hfGLCompanyId.ClientID %>").val(companyId);
            $("#<%=hfGLCompanyName.ClientID %>").val(companyName);
            $("#<%=hfGLProjectName.ClientID %>").val(projectName);
            ...
            $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLCompany").change(function () {
                ...
                companyName = $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLCompany :selected ").text();
                $("#<%=hfGLCompanyId.ClientID %>").val(companyId);
                $("#<%=hfGLCompanyName.ClientID %>").val(companyName);
            });
            ...
            $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLProject").change(function () {
                ...
                projectName = $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLProject :selected ").text();
    ...
    <div id="myTabs">
        <ul id="tabPage" class="ui-style">
            ...
            <li id="A" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                href="#tab-1">Salary Formula Entry</a></li>
            <li id="B" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                href="#tab-2">Search Salary Formula </a></li>
        </ul>
        <div id="tab-3">
        ...
        <div id="tab-1">
            <div id="EntryPanel" class="panel panel-default">
                <div class="panel-heading">Salary Formula Information</div>
...
<script type="text/javascript">
    $(document).ready(function () {            
        if ($("#ContentPlaceHolder1_companyProjectUserControl_hfIsSingle").val() != "1") {
            ...
            var p = $("#ContentPlaceHolder1_hfGLProjectId").val();
            ...
            $("#ContentPlaceHolder1_companyProjectUserControl_ddlGLProject").val($("#ContentPlaceHolder1_hfGLProjectId").val()).trigger("change");
