...
{
    public partial class frmGratuityConfiguration : BasePage
    {
        ...
        private void CheckObjectPermission()
        {
            ...
            objectPermissionBO = hmUtility.ObjectPermission(userInformationBO.UserInfoId, HMConstants.ApplicationFormName.frmPayrollConfiguration.ToString());
        ...
        protected void btnSalaryProcess_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                EntityTypeEnum.EntityType.EmpSalaryProcess.ToString(), commonSetupBO.SetupId,
        ...
        protected void btnSalaryMonthStartDateInfoSave_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(),
                EntityTypeEnum.EntityType.SalaryFormula.ToString(), commonSetupBO.SetupId,
                ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
            ...
            else
            {
                ...
                bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Add.ToString(),
                            EntityTypeEnum.EntityType.SalaryFormula.ToString(), tmpSetupId,
                            ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
                            hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.SalaryFormula));
        ...
        protected void btnBonusMonthlyPeriodInfoSave_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(),
                EntityTypeEnum.EntityType.BonusConfiguration.ToString(), commonSetupBO.SetupId,
                ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
        ...
        protected void btnBasicHeadSetup_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(),
                EntityTypeEnum.EntityType.SalaryHead.ToString(), commonSetupBO.SetupId,
                ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
        ...
        protected void btnOverTimeInfoSave_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(),
                EntityTypeEnum.EntityType.OverTimeSetup.ToString(), commonSetupBO.SetupId,
                ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
                hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.OverTimeSetup));
            }
            else
            {
                //this.isMessageBoxEnable = 2;
        ...
        protected void btnMonthlyWorkingDay_Click(object sender, EventArgs e)
        {
            ...
            if (tmpSetupId == 0)
            {
                ...
                ProjectModuleEnum.ProjectModule.CommonConfiguration.ToString(),
                hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.MonthlyWorkingDayConfiguration));
        ...
        protected void btnEmpPFSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pfBO.EmployeeContributionInPercentage = Convert.ToInt32(this.txtEmpCont.Text.Trim());
                pfBO.CompanyContributionInPercentange = Convert.ToInt32(this.txtCmpCont.Text.Trim());
                pfBO.EmployeeCanContributeMaxOfBasicSalary = Convert.ToInt32(this.txtEmpMaxCont.Text.Trim());
                ...
                if (hiddenId > 0)
                {
                    ...
                    //Boolean status = pfDA.UpdateEmpPFInfo(pfBO);
                    //if (status)
                    //{                        
                    //    CommonHelper.AlertInfo(innboardMessage, AlertMessage.Update, AlertType.Success);
                    //}
                ...
                else
                {
                    ...
                    //Boolean status = pfDA.SaveEmpPFInformation(pfBO);
                    //if (status)
                    //{                        
                    //    CommonHelper.AlertInfo(innboardMessage, AlertMessage.Save, AlertType.Success);
                    //    LoadPF();
            ...
            try
            {
                ...
                if (bonusBO.BonusType == "FestivalBonus")
                {
                    ...
                    if (addList.Count > 0 || deleteList.Count > 0)
                    {
                        ...
                        {
                            bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Add.ToString(),
                          EntityTypeEnum.EntityType.BonusConfiguration.ToString(), 0,
                          ProjectModuleEnum.ProjectModule.PayrollManagement.ToString(),
                          "Employee's Fastive Bonus Saved");
                ...
                else
                {
                    if (!string.IsNullOrWhiteSpace(hfBonusId.Value))
                    {
                        ...
                        {
                           bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(),
                           EntityTypeEnum.EntityType.BonusConfiguration.ToString(), bonusBO.BonusSettingId,
                           ProjectModuleEnum.ProjectModule.PayrollManagement.ToString(),
                           hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.BonusConfiguration));
                    ...
                    else
                    {
                        ...
                        {
                            bool logStatus = hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Add.ToString(),
                          EntityTypeEnum.EntityType.BonusConfiguration.ToString(), tmpId,
                          ProjectModuleEnum.ProjectModule.PayrollManagement.ToString(),
                          hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.BonusConfiguration));
        ...
        {            
            try
            {
                ...
                if (status)
                {
                    //For the time being, Parsing the Reader ID to long because of the method only allowed long value.
                    //This parsing will not give accurate data if any string value come to parse here.
        ...
        private bool IsPFFrmValid()
        {
            ...
            else if (int.TryParse(txtEmpCont.Text, out checkNumber) == false)
            {                
                CommonHelper.AlertInfo(innboardMessage, "You have not entered a valid number.", AlertType.Warning);
                flag = false;
                txtEmpCont.Focus();
            ...
            else if (int.TryParse(txtCmpCont.Text, out checkNumber) == false)
            {                
                CommonHelper.AlertInfo(innboardMessage, "You have not entered a valid number.", AlertType.Warning);
                flag = false;
                txtCmpCont.Focus();
            ...
            else if (int.TryParse(txtEmpMaxCont.Text, out checkNumber) == false)
            {                
                CommonHelper.AlertInfo(innboardMessage, "You have not entered a valid number.", AlertType.Warning);
                flag = false;
                txtEmpMaxCont.Focus();
            }
            else if (int.TryParse(txtIntDisRt.Text, out checkNumber) == false)
            {                
                CommonHelper.AlertInfo(innboardMessage, "You have not entered a valid number.", AlertType.Warning);
                flag = false;
                txtIntDisRt.Focus();
            ...
            else if (int.TryParse(txtCmpContElegYear.Text, out checkNumber) == false)
            {
                CommonHelper.AlertInfo(innboardMessage, "You have not entered a valid number.", AlertType.Warning);
                flag = false;
                txtCmpContElegYear.Focus();
