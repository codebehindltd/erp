<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HM.Master" AutoEventWireup="true"
    CodeBehind="frmEmpDashboard.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.frmEmpDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Employee Wise Dashboard</li>";
    ...
    <div class="divFullSectionWithTwoDvie">
        ...
        <div class="divBox divSectionLeftRightSameWidth">
            <div id="DashboardPanel6" class="block">
