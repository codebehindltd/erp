<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="LeaveWorkHandoverInfo.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.LeaveWorkHandoverInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function ApproveLeaveApp(leaveId, status) {
            if (!confirm("Do you Want To Accept Work Handover?")) {
                return false;
            }
            //FillForm(leaveId);
            RequestOff("Leave Work Handover Acceptance", status);
        ...
        function Approval() {
            ...
            if (action == "0") {
                toastr.warning("Please Provide Work Handover Status.");
                return false;
            }
        ...
        function RequestOff(msg, status) {
            ...
            $("#<%=ddlStatus.ClientID %>").val(0);
            //if (status == "Pending") {
            //    if (drop.options[2].value == "Accepted") {
            //        drop.options[2].hidden = true;
            //    }
            //}
            //else if (status == "Checked") {
            //    if (drop.options[1].value == "Rejected") {
            ...
            <div class="form-horizontal">
                ...
                <div id="ApprovalDiv" style="display: none">
                    <div class="form-group" id="statusDiv">
                        <div class="col-md-2">
                            <asp:Label ID="Label7" runat="server" class="control-label" Text="Handover Status"></asp:Label>
                        </div>
                        <div class="col-md-4">
