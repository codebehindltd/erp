<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmEmployeeInformation.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.frmEmployeeInformation" ViewStateMode="Enabled" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //debugger;
            var canEditDetails = $("#<%=hfIsEmployeeCanEditDetailsInfo.ClientID %>").val();
            //var controls = document.getElementById("EmployeeDetailsInformation").getElementsByTagName("input");
            //var controlsSelect = document.getElementById("EmployeeDetailsInformation").getElementsByTagName("select");

            if (canEditDetails == "1") {
                //$("#EmployeeDetailsInformation :input").prop("disabled", false);
               

            }
            else {
                //$("#EmployeeDetailsInformation :input").prop("disabled", true);
                $("#<%=txtFathersName.ClientID %>").attr('disabled','disabled');
                $("#<%=txtMothersName.ClientID %>").attr('disabled','disabled');
                <%--$("#<%=txtEmpDateOfBirth.ClientID %>").attr('disabled','disabled');--%>
                //$("#<%=ddlGender.ClientID %>").attr('disabled','disabled');
               <%-- $("#<%=ddlBloodGroup.ClientID %>").attr('disabled','disabled');--%>
                $("#<%=txtHeight.ClientID %>").attr('disabled','disabled');
                <%--$("#<%=ddlReligion.ClientID %>").attr('disabled','disabled');--%>
               <%-- $("#<%=ddlMaritalStatus.ClientID %>").attr('disabled','disabled');--%>
               <%-- $("#<%=ddlCountryId.ClientID %>").attr('disabled','disabled');
                $("#<%=txtNationalId.ClientID %>").attr('disabled','disabled');--%>
                $("#<%=ddlDivision.ClientID %>").attr('disabled','disabled');
                $("#<%=ddlDistrict.ClientID %>").attr('disabled','disabled');
                $("#<%=ddlThana.ClientID %>").attr('disabled','disabled');
                $("#<%=txtTinNumber.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPassportNumber.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPIssueDate.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPIssuePlace.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPExpireDate.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPresentAddress.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPresentCity.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPresentZipCode.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPresentCountry.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPresentPhone.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPermanentAddress.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPermanentCity.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPermanentZipCode.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPermanentCountry.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPermanentPhone.ClientID %>").attr('disabled','disabled');
                $("#<%=txtPersonalEmail.ClientID %>").attr('disabled','disabled');
                $("#<%=txtAlternativeEmail.ClientID %>").attr('disabled','disabled');
                $("#<%=txtEmergencyContactName.ClientID %>").attr('disabled','disabled');
                $("#<%=txtEmergencyContactRelationship.ClientID %>").attr('disabled','disabled');
                $("#<%=txtEmergencyContactNumber.ClientID %>").attr('disabled','disabled');
                $("#<%=txtEmergencyContactEmail.ClientID %>").attr('disabled','disabled');
               <%-- $("#<%=ddlCurrentLocation.ClientID %>").attr('disabled','disabled');--%>


            }
            $("#BankDiv :input").prop("disabled", true);
           ...
           <%-- var hfIsPayrollLetterPanelHide = $("#<%=hfIsPayrollLetterPanelHide.ClientID %>").val();
            ...
            $('#ContentPlaceHolder1_companyProjectUserControl_ddlGLCompany').prop('disabled', 'disabled');
            $('#ContentPlaceHolder1_companyProjectUserControl_ddlGLProject').prop('disabled', 'disabled');
        });
        ...
        function OnDeleteDocSucceeded(result) {
            if (result == true) {
                ...
                toastr.error("Delete operation unsuccessful.");
            }
        }
        ...
        function ConfirmUpdate() {
            ...
            //debugger;
            //window.history.replaceState(null, null, history.state);
            // window.onpopstate();
        }
        ...
        function GridPaging(pageNumber, IsCurrentOrPreviousPage) {
            ...
            PageMethods.SearchNLoadEmpInformation(empName, code, department, designation, gridRecordsCount, pageNumber, IsCurrentOrPreviousPage, OnLoadObjectSucceeded, OnLoadObjectFailed);
            return false;--%>
        }
    ...
    <asp:HiddenField ID="hfIsEmployeeCanEditDetailsInfo" runat="server" Value="0"></asp:HiddenField>
    ...
    <div id="myTabs">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" id="EmployeeCompanyControlDiv">
                                <asp:DropDownList ID="ddlEmpCompanyId" runat="server" CssClass="form-control" Enabled="false">
                                </asp:DropDownList>
                            </div>
                        </div>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:DropDownList ID="ddlBloodGroup" runat="server" CssClass="form-control" Enabled="false">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-2">
        ...
        <div id="tab-8">
            <%--<asp:CheckBoxList ID="chkBenefitList" runat="server" CssClass="customChkBox">
            </asp:CheckBoxList>--%>
            <asp:GridView ID="gvBenefit" Width="100%" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Applicable Date" ShowHeader="False" ItemStyle-Width="30%">
                        <ItemTemplate>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <%--<div class="childdivSection">
                            <div id="EmpOthersDocumentsInformation" class="panel panel-default" style="height: 270px;">
                                <div class="panel-heading">
                                    Others Document Information
                                </div>
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                <asp:Label ID="lblOthersDocumant" runat="server" Text="Employee Others Document"></asp:Label>
                            </div>
                            <div class="col-md-4">
                                <input id="btnOthersDocument" type="button" onclick="javascript: return LoadOthersDocumentUploader();"
                                    class="TransactionalButton btn btn-primary" value="Upload Picture" />
                            </div>
                            <div class="divClear">
                            </div>
    ...
    <div class="row" id="SubmitButtonDiv" style="padding-top: 10px;">
        <div class="form-group">
            <div class="col-md-1">
                <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="TransactionalButton btn btn-primary" OnClientClick="javascript: return ConfirmUpdate();"
