<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportEmployeeBill.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmReportEmployeeBill" %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlReportStatus" runat="server" CssClass="form-control">
                            <asp:ListItem Text="Employee Bill" Value="EmployeBill"></asp:ListItem>
                            <asp:ListItem Text="Employee Generated Bill" Value="EmployeGeneratedBill"></asp:ListItem>
                            <asp:ListItem Text="Employee Generated Due Bill" Value="EmployeGeneratedDueBill"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
