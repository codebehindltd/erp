<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportEmpTraining.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmReportEmpTraining" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Employee Training Report</li>";
    ...
    <div id="SearchPanel" class="panel panel-default">       
            <div class="panel-heading">Employee Training
            Info</div>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList ID="ddlTrainingTypeId" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>
            </div>            
            <div class="form-group">
