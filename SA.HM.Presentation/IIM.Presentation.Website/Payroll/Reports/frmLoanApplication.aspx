<%@ Page Title="" Language="C#" MasterPageFile="~/Common/ReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmLoanApplication.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmLoanApplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Loan Application Form</li>";
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <%--<a href="#page-stats" class="block-heading" data-toggle="collapse">Loan Application Form</a>--%>
