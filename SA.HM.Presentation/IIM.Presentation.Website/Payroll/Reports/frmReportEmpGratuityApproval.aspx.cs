...
{
    public partial class frmReportEmpGratuityApproval : BasePage
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string reportPath = Server.MapPath(@"~/Payroll/Reports/Rdlc/RptEmpGratuityApproval.rdlc");
            ...
            List<EmpGratuityBO> viewList = new List<EmpGratuityBO>();
            viewList = gratuityDA.GetEmpGratuityInfoForReport(empId);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], viewList));

            rvTransaction.LocalReport.DisplayName = "Gratuity Approval";
