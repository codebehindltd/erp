...
{
    public partial class frmReportEmployeeBirthday : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Payroll/Reports/Rdlc/rptEmployeeBirthday.rdlc");
            ...
            list = reportDA.GetEmployeeBirthdayInformationforReport(fromDate, toDate);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], list));

            rvTransaction.LocalReport.DisplayName = "Employee Birthday Information";
