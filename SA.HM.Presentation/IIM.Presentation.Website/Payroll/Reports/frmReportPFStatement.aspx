<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmReportPFStatement.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmReportPFStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>PF Statement</li>";
                ...
                <div class="form-group" id="EmployeeInformationDiv" runat="server">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList AutoPostBack="true" ID="ddlDepartment" runat="server" CssClass="form-control"
                            OnSelectedIndexChanged="EmpDropDown_Change" TabIndex="4">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
