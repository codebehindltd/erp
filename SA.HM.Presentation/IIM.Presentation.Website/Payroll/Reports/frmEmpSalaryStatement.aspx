<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmEmpSalaryStatement.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmEmpSalaryStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Salary Statement</li>";
    ...
    <div id="SearchPanel" class="panel panel-default">
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2">
                        <asp:Label ID="lblFromYear" runat="server" class="control-label required-field" Text="From Year"></asp:Label>                      
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="lblFromMonth" runat="server" class="control-label required-field" Text="From Month"></asp:Label>                      
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <div class="col-md-2">
                        <asp:Label ID="lblToYear" runat="server" class="control-label required-field" Text="To Year"></asp:Label>                       
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="lblToMonth" runat="server" class="control-label required-field" Text="To Month"></asp:Label>                       
                    </div>
                    <div class="col-md-4">
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">
            Report:: Employee Salary Statement</div>
        <div class="panel-body">
