<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmEmployeeServiceChargeBankAdvice.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmEmployeeServiceChargeBankAdvice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="SearchPanel" class="panel panel-default">
        <div class="panel-heading">
            Service Charge Distribution Info</div>
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="col-md-2">
                    <asp:Label ID="Label1" runat="server" class="control-label required-field" Text="Bank Name"></asp:Label>                   
                </div>
                <div class="col-md-4">
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">
            Service Charge Distribution</div>
        <div class="panel-body">
