...
{
    public partial class frmReportAppraisalEvaluationDetails : BasePage
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            empId = ((HiddenField)employeeSearch.FindControl("hfEmployeeId")).Value;
            ...
            string reportPath = Server.MapPath(@"~/Payroll/Reports/Rdlc/RptAppraisalEvaluationDetails.rdlc");
            ...
            viewList = appEvaDA.GetAppraisalEvaluationDetailsForReport(departmentId, appraisalType, empId, FromDate, ToDate);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], viewList));

            rvTransaction.LocalReport.DisplayName = "Appraisal Evaluation Details";
