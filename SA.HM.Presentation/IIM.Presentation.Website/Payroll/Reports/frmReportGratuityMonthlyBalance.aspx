<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportGratuityMonthlyBalance.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmReportGratuityMonthlyBalance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Gratuity Monthly Balance</li>";
    ...
    <div id="SearchPanel" class="panel panel-default">       
         <div class="panel-heading">Gratuity Monthly Balance</div> 
