...
{
    public partial class frmReportEmployeePaymentInvoiceVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.Session["EmployeeBillPaymentIdList"] = string.Empty;
                    this.Session["EmployeeBillPaymentIdList"] = Request.QueryString["PaymentIdList"];
                    Response.Redirect("/Payroll/Reports/frmReportEmployeePaymentInvoiceVoucher.aspx");
                }
                else
                {
                    this.Session["EmployeeBillPaymentIdList"] = string.Empty;
                    this.Session["EmployeeBillPaymentIdList"] = queryStringIdList;
                    ReportProcessing();
                }
            }
        }
        ...
        private void ReportProcessing()
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Payroll/Reports/Rdlc/RptEmployeePaymentInvoiceVoucher.rdlc");
            ...
            string paymentIdList = Session["EmployeeBillPaymentIdList"].ToString();
            ...
            //reservationBillBOList = reservationBillDA.GetReservationBillPaymentForReport(searchCriteria, type);
            reservationBillBOList = reservationBillDA.GetReservationPaymentInvoiceInformation(paymentIdList);
            paramReport.Add(new ReportParameter("ReservationNumber", reservationBillBOList.Count <=  0 ? "" : reservationBillBOList[0].RegistrationNumber ));
            rvTransaction.LocalReport.SetParameters(paramReport);
