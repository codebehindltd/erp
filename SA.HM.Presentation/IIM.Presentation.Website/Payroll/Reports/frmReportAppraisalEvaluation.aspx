<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportAppraisalEvaluation.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.Reports.frmReportAppraisalEvaluation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="SearchPanel" class="panel panel-default">
        <div class="panel-heading">Appraisal Evaluation Info</div>
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div id="AppraisalEvaluation">
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            <asp:Label ID="lblAppraisalType" runat="server" class="control-label required-field" Text="Appraisal Type"></asp:Label>
                        </div>
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlAppraisalType" runat="server" CssClass="form-control"
                                TabIndex="3">
                        ...
                        <div class="col-md-2">
                            <asp:Label ID="lblLeaveMode" runat="server" class="control-label required-field" Text="Department"></asp:Label>
                        </div>
                        <div class="col-md-4">
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">Appraisal Evaluation</div>
        <div class="panel-body">
