...
namespace HotelManagement.Presentation.Website.Payroll
{
    ...
    {
        //public frmEmployeeInformation() : base("frmEmployee")
        //{
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var canEditDetails = hfIsEmployeeCanEditDetailsInfo.Value;
            ...
            //Bank Info
            string strEmpId = Session["_EmployeeId"].ToString();
            employeeBO.EmpId = Convert.ToInt32(strEmpId);

            EmpBankInfoBO bankInfo = new EmpBankInfoBO();
            EmpBankInfoBO existingBankInfo = new EmpBankInfoBO();
            existingBankInfo = employeeDA.GetEmployeeBankInfo(employeeBO.EmpId);
            if (existingBankInfo != null)
            {
                if (existingBankInfo.BankId > 0)
                {
                    bankInfo.BankInfoId = existingBankInfo.BankInfoId;
                    bankInfo.BankId = existingBankInfo.BankId;
                    bankInfo.BranchName = existingBankInfo.BranchName;
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                if (cb.Checked == true)
                {
                    ...
                    //benefitBO.EffectiveDate = Convert.ToDateTime(txtBenefitEffectiveDate.Text);
        ...
        private void LoadReportingTo()
        {
            ...
            {
                //hfReportingTo.Value = commonSetupBO.SetupId.ToString();
        ...
        private bool IsFormValid()
        {
            ...
            else if (ddlGender.SelectedIndex == 0 && canEditDetails == "1")
            {
            ...
            else if (ddlReligion.SelectedIndex == 0 && canEditDetails == "1")
            {
            ...
            else if (ddlMaritalStatus.SelectedIndex == 0 && canEditDetails == "1")
            {
            ...
            else if (ddlCountryId.SelectedIndex == 0 && canEditDetails == "1")
            {
        ...
        private void FillForm(int EditId)
        {
            ...
            //empTypeBO = empTypeDA.GetEmpTypeInfoById(Convert.ToInt32(bo.EmpTypeId));

            //if (empTypeBO != null)
            //{
            //    if (empTypeBO.TypeId > 0)
            //    {
            //        if (empTypeBO.IsContractualType)
            //        {
            //            if (bo.ResignationDate != null)
            //            {
            //                txtContractEndDate.Text = hmUtility.GetStringFromDateTime(Convert.ToDateTime(bo.ResignationDate));
            //            }
            //            else
            //            {
        ...
        private void Cancel()
        {
            ...
            ddlWorkStation.SelectedValue = string.Empty;
        ...
        private void CanEmployeeEditDetailsInfoBO()
        {
            HMCommonSetupDA commonSetupDA = new HMCommonSetupDA();
            HMCommonSetupBO IsEmployeeCanEditDetailsInfoBO = new HMCommonSetupBO();
            IsEmployeeCanEditDetailsInfoBO = commonSetupDA.GetCommonConfigurationInfo("IsEmployeeCanEditDetailsInfo", "IsEmployeeCanEditDetailsInfo");

            if (IsEmployeeCanEditDetailsInfoBO != null)
            {
                if (IsEmployeeCanEditDetailsInfoBO.SetupValue == "1")
                {
                    hfIsEmployeeCanEditDetailsInfo.Value = "1";
                }
                else
                    hfIsEmployeeCanEditDetailsInfo.Value = "0";
            }
        }
        //------Common For All------------------------
        ...
        [WebMethod]
        public static GridViewDataNPaging<EmployeeBO, GridPaging> SearchNLoadEmpInformation(string empName, string code, string department, string designation, int gridRecordsCount, int pageNumber, int isCurrentOrPreviousPage)
        {
            UserInformationBO userInformationBO = new UserInformationBO();
