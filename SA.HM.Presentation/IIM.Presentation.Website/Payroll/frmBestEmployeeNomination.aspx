<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmBestEmployeeNomination.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.frmBestEmployeeNomination" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Best Employee Nomination</li>";
        ...
        function EmployeeNominationSave() {
            ...
            BestEmployeeNomination = {
                ...
                Months: $("#ContentPlaceHolder1_ddlSelectionMonth").val()
            };
            ...
            PageMethods.SaveBestEmployeeNomination(BestEmployeeNomination, BestEmployeeNominationDetails, processType, OnEmployeeNominationSucceeded, OnEmployeeNominationFailed);
            return false;
        }
    ...
    <div id="myTabs">
        <ul id="tabPage" class="ui-style">
            <li id="A" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                href="#tab-1">Best Employee Nomination</a></li>
            <li id="B" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                href="#tab-2">Employee Nomination Search</a></li>
        </ul>
        <div id="tab-1">
            <div id="ApprEvaluationEntryPanel" class="panel panel-default">
                <div class="panel-heading">
                    Employee Nomination</div>
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:DropDownList AutoPostBack="true" ID="ddlDepartmentId" runat="server" CssClass="form-control"
                                    OnSelectedIndexChanged="DepartmentDropDown_Change">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:DropDownList AutoPostBack="true" ID="ddlSelectionYear" runat="server" CssClass="form-control"
                                    OnSelectedIndexChanged="YearDropDown_Change">                                    
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Button ID="btnEmpApprEvaluation" runat="server" Text="Save" TabIndex="2" CssClass="TransactionalButton btn btn-primary"
                                    OnClientClick="javascript:return EmployeeNominationSave()" />
        ...
        <div id="tab-2">
            <div id="SearchEntry" class="panel panel-default">
                <div class="panel-heading">
                    Employee Nomination Search</div>
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-2">
