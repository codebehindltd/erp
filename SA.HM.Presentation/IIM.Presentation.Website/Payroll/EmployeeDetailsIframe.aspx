    ...
    <script type="text/javascript">
        ...
        function LoadTable(searchData) {
            ...
            $.each(searchData.d.GridData, function (count, gridObject) {
                ...
                tr += "<td align='left'  style='width: 5%; cursor:pointer' title='Emnployee details' onClick='javascript:return LoadDetails(" + gridObject.EmpId + ")'>" + gridObject.EmpCode + "</td>";
                ...
                tr += "<td align='left' style='width: 5%; cursor:pointer' title='Emnployee details' onClick='javascript:return LoadDetails(" + gridObject.EmpId + ")'>" + gridObject.PABXNumber + "</td>";
