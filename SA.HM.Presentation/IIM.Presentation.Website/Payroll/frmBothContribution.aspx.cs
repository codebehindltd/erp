...
{
    public partial class frmBothContribution : BasePage
    {
        ...
        protected void gvSalaryFormula_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "CmdDelete")
            {
                ...
                try
                {
                    Boolean status = hmCommonDA.DeleteInfoById("PayrollSalaryFormulaForBothContribution", "FormulaId", formulaId);
                    if (status)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(txtFormulaId.Value))
                {
                    ...
                    Boolean status = salaryFormulaDA.SaveBothContributionSalaryFormulaInfo(salaryFormulaBO, out tmpUserInfoId);
                ...
                else
                {
                    ...
                    Boolean status = salaryFormulaDA.UpdateBothContributionSalaryFormulaInfo(salaryFormulaBO);
        ...
        public void LoadGridView(SalaryFormulaBO salaryFormula)
        {
            ...
            files = salaryFormulaDA.GetBothContributionSalaryFormulaInfoBySearchCritaria(salaryFormula);
        ...
        public void FillForm(int EditId)
        {
            ...
            SalaryFormulaBO salaryFormulaBO = new SalaryFormulaBO();
            SalaryFormulaDA salaryFormulaDA = new SalaryFormulaDA();
            salaryFormulaBO = salaryFormulaDA.GetBothContributionSalaryFormulaInfoById(EditId);
        ...
        public static SalaryFormulaViewBO GetEmployeeWiseSalaryFormulaHead(int employeeId)
        {
            ...
            try
            {
                salaryFormula.EmployeeIndividualWise = formulaDa.GetBothContributionSalaryFormulaInfoByEmpId(employeeId);
                salaryFormula.EmployeeGradeWise = formulaDa.GetBothContributionSalaryFormulaByEmpGradeId(employeeId);
        ...
        public static ReturnInfo SaveEmployeeWiseSalaryFormula(List<SalaryFormulaBO> salaryFormula, List<SalaryFormulaBO> salaryFormulaEdited, List<SalaryFormulaBO> salaryFormulaDeleted)
        {
            ...
            try
            {
                ...
                {
                    status = salaryDa.SaveBothContributionSalaryFormulaInfo(salaryFormula, userInformationBO.UserInfoId, out tmpId);
                    if (status == true)
                    {
                ...
                {
                    status = salaryDa.UpdateBothContributionSalaryFormulaInfo(salaryFormulaEdited, userInformationBO.UserInfoId);
                    if (status == true)
                    {
                        rtninf.IsSuccess = true;
                ...
                {
                    status = salaryDa.DeleteBothContributionSalaryFormulaInfo(salaryFormulaDeleted);
                    if (status == true)
                    {
                        rtninf.IsSuccess = true;
