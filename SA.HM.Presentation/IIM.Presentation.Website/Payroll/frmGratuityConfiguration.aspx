<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmGratuityConfiguration.aspx.cs" Inherits="HotelManagement.Presentation.Website.Payroll.frmGratuityConfiguration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div id="GratutityEntryPanel" class="panel panel-default" >           
                <div class="panel-heading">Employee Gratuity
                Information</div>
        ...
        <div class="form-horizontal">   
                <div class="form-group">
                    <div class="col-md-2">
                        ...
                        <asp:Label ID="lblNoofJobYearfrGrty" runat="server" class="control-label required-field" Text="No Of Job Year"></asp:Label>                        
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="lblGrtyNoAdded" runat="server" class="control-label required-field" Text="No. Of Gratuity Added"></asp:Label>                        
                    </div>
                    <div class="col-md-4">
 ...
 <div class="col-md-12">
    ...
    <div style="display: none;">
        ...
        <div id="myTabs">
            ...
            <div id="tab-3">
                <div id="PFEntryPanel" class="block">
                    <a href="#page-stats" class="block-heading" data-toggle="collapse">Employee Provident
                        Fund Information </a>
                    <div class="HMBodyContainer">
                        <div class="form-group">
                            <div class="divBox divSectionLeft">
                                <asp:HiddenField ID="txtPFSettingId" runat="server"></asp:HiddenField>
                                <asp:Label ID="lblEmpCont" runat="server" Text="Employee Contribution (%)"></asp:Label>
                                <span class="MandatoryField">*</span>
                            </div>
                            <div class="divBox divSectionRight">
                                <asp:TextBox runat="server" ID="txtEmpCont" TabIndex="3">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="divClear">
                        ...
                        <div class="form-group">
                            <div class="divBox divSectionLeft">
                                <asp:Label ID="lblCmpCont" runat="server" Text="Company Contribution (%)"></asp:Label>
                                <span class="MandatoryField">*</span>
                            </div>
                            <div class="divBox divSectionRight">
                                <asp:TextBox runat="server" ID="txtCmpCont" TabIndex="3">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="divClear">
                        ...
                        <div class="form-group">
                            <div class="divBox divSectionLeft">
                                <asp:Label ID="lblEmpMaxCont" runat="server" Text="Employee Can Contribute Max Of Basic Salary (%)"></asp:Label>
                                <span class="MandatoryField">*</span>
                            </div>
                            <div class="divBox divSectionRight">
                                <asp:TextBox runat="server" ID="txtEmpMaxCont" TabIndex="3">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="divClear">
                        ...
                        <div class="form-group">
                            <div class="divBox divSectionLeft">
                                <asp:Label ID="lblIntDisRt" runat="server" Text="Interest Distribution Rate (%)"></asp:Label>
                                <span class="MandatoryField">*</span>
                            </div>
                            <div class="divBox divSectionRight">
                                <asp:TextBox runat="server" ID="txtIntDisRt" TabIndex="3">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="divClear">
                        ...
                        <div class="form-group">
                            <div class="divBox divSectionLeft">
                                <asp:Label ID="lblCmpContElegYear" runat="server" Text="Company Contribution Elegibility (Year)"></asp:Label>
                                <span class="MandatoryField">*</span>
                            </div>
                            <div class="divBox divSectionRight">
                                <asp:TextBox runat="server" ID="txtCmpContElegYear" TabIndex="3">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="divClear">
            ...
            <div id="tab-4">
                <div id="LoanEntryPanel" class="block">
                    ...
                    <div class="HMBodyContainer">
                        <div class="form-group">
                            <div class="divBox divSectionLeft" style="width: 350px;">
