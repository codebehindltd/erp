...
{
    public partial class CompanyProjectUserControl : System.Web.UI.UserControl
    {
        HMUtility hmUtility = new HMUtility();
        public string ConnfigurationID { get; set; }
        public string ddlFirstValueVar { get; set; }
        public string CompanyLabelText { get; set; }
        public string ProjectLabelText { get; set; }
        ...
        {
            if (String.IsNullOrEmpty(ddlFirstValueVar))
            {
                ddlFirstValueVar = "all";
                hfDropdownFirstValue.Value = "all";
            }
            else
            {
                hfDropdownFirstValue.Value = ddlFirstValueVar;
            }


            if (String.IsNullOrEmpty(CompanyLabelText))
            {
                lblGLCompany.Text = "Company";
            }
            else
            {
                lblGLCompany.Text = CompanyLabelText;
            }

            if (String.IsNullOrEmpty(ProjectLabelText))
            {
                lblGLProject.Text = "Project";
            }
            else
            {
                lblGLProject.Text = ProjectLabelText;
            }
        }
