<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmDashboardManagement.aspx.cs" Inherits="HotelManagement.Presentation.Website.HMCommon.frmDashboardManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    Number"></asp:Label>
                                ...
                                <div id="PaxInRateInfoDiv" class="form-group">
                                    <div class="col-md-2">
                                        <asp:Label ID="lblPaxInRate" runat="server" class="control-label" Text="Pax In Rate"></asp:Label>
                                    </div>
                                    <div class="col-md-2" style="padding-right: 0;">
                                        ...
                                        <asp:TextBox ID="txtPaxInRate" runat="server" CssClass="form-control" TabIndex="1"></asp:TextBox>
                                    </div>
                                    <div class="col-md-2" style="padding-left: 5px;">
                                        <asp:Button ID="btnPaxInRateUpdate" runat="server" TabIndex="4" Text="Update" CssClass="TransactionalButton btn btn-primary btn-sm"
                ...
                <div id="Poptab-3">
                    <div id="Div3" class="panel panel-default" style="font-weight: bold">
                        <div class="panel-heading">
                            Preferences</div>
                        <div id="Preference">
                        </div>
                ...
                <div class="row" style="margin-top: -20px;">
                    ...
                    <div class="col-md-4" style="margin-top: 10px; margin-right: 15px; text-align: right;
                        float: right;">
    ...
    <div class="row">
        <div id="DashboardManagementDiInfo" class="col-md-12" style="text-align: right;">
            <asp:LinkButton ID="lbtnDashboardManagement" runat="server" OnClick="lbtnDashboardManagement_Click">Dashboard</asp:LinkButton>
        </div>
    </div>
</asp:Content>
