<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportCnfLedger.aspx.cs" Inherits="HotelManagement.Presentation.Website.LCManagement.Reports.frmReportCnfLedger" %>
            ...
            $("#txtSearch").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        url: 'frmReportCNFLedger.aspx/GetSuplierData',
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control">
                            ...
                            <asp:ListItem Text="All CNF" Value="0"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <div class="form-group" id="companysearch">
                    <div class="col-md-2">
                        <asp:Label ID="Label1" runat="server" class="control-label required-field" Text="CNF Name"></asp:Label>
                    </div>
                    <div class="col-md-10">
