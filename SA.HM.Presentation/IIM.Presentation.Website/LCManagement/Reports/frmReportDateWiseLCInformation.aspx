<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportDateWiseLCInformation.aspx.cs" Inherits="HotelManagement.Presentation.Website.LCManagement.Reports.frmReportDateWiseLCInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            var moduleName = "<a href='/HMCommon/frmHMHome.aspx' class='inActive'>LC Management</a>";
            var formName = "<span class='divider'>/</span><li class='active'>LC Information</li>";
            ...
            var searchType = $('#' + ddlReportType).val();
            if (searchType == "Supplier") {
                $('#SupplierDiv').show();
                $('#LCNumberDiv').hide();
                $('#DateRangeDiv').show();
            }
            else if (searchType == "LCNumber") {
                $('#SupplierDiv').hide();
                $('#LCNumberDiv').show();
                $('#DateRangeDiv').hide();
            }
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control" TabIndex="1">
                            <asp:ListItem Value="Open">LC Open</asp:ListItem>
                            <asp:ListItem Value="Mature">LC Mature</asp:ListItem>
                            <asp:ListItem Value="Settle">LC Settlement</asp:ListItem>
                            <%--<asp:ListItem Value="Cancel">LC Cancel</asp:ListItem>--%>
                            <asp:ListItem Value="Supplier">Supplier Wise</asp:ListItem>
                            <asp:ListItem Value="LCNumber">LC Number Wise</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    ...
                    <div id="LCNumberDiv" style="display: none;">
                        <div class="col-md-2">
                            <asp:Label ID="Label1" runat="server" class="control-label" Text="LC Number"></asp:Label>
                        </div>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtLCNumber" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div id="DateRangeDiv" class="form-group">
                    <div class="col-md-2">
