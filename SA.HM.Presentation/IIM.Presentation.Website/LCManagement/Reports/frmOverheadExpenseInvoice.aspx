<%@ Page Title="" Language="C#" MasterPageFile="~/Common/ReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmOverheadExpenseInvoice.aspx.cs" Inherits="HotelManagement.Presentation.Website.LCManagement.Reports.frmOverheadExpenseInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            var moduleName = "<a href='/HMCommon/frmHMHome.aspx' class='inActive'>LC</a>";
            var formName = "<span class='divider'>/</span><li class='active'>Overhead Expense Invoice</li>";
