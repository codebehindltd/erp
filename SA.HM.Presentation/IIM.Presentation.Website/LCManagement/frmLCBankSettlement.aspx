<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmLCBankSettlement.aspx.cs" Inherits="HotelManagement.Presentation.Website.LCManagement.frmLCBankSettlement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var ddlLcBankAccountHead = '<%=ddlLcBankAccountHead.ClientID%>'
            $('#' + ddlLcBankAccountHead).change(function () {
                //toastr.info("Hi...");
                var ddlReservationId = '<%=ddlReservationId.ClientID%>';
                var lcId = $('#' + ddlReservationId).val();
                var accountHeadId = $('#' + ddlLcBankAccountHead).val();
                PageMethods.LoadLCPaymentInformation(lcId, accountHeadId, OnLoadLCPaymentInformationSucceeded, OnLoadLCPaymentInformationFailed);
            });
            ...
            $("#btnAddDetailGuestPayment").click(function () {
                ...
                if (regId > 0) {
                    ...
                    if (isValid == false) {
                        ...
                        toastr.info('Please provide Payment Amount.');
                        return;
                    }
            ...
            $(document).ready(function () {
                ...
                $('#' + ddlPayMode).change(function () {
                    $('#' + lblReceiveLeadgerAmount).text("Payment Amount");
                    if ($('#' + ddlPayMode).val() == "Cash") {
                        $('#CardPaymentAccountHeadDiv').hide();
                        $('#ChecquePaymentAccountHeadDiv').hide();
                        $('#MBankingPaymentAccountHeadDiv').hide();
        ...
        function OnLoadLCPaymentInformationSucceeded(result) {
            $("#<%=txtBankContributeAmount.ClientID %>").val(result);
        }
        function OnLoadLCPaymentInformationFailed(error) {
        ...
        function SaveGuestPaymentDetailsInformationByWebMethod() {
            ...
            if (floatAmout <= 0) {
                toastr.warning('Payment Amount is not in correct format.');
                return;
            }
            ...
            var ddlChecquePaymentAccountHeadId = $("#<%=ddlChequeBankId.ClientID %>").val();
            ...
            if ($("#<%=txtReceiveLeadgerAmount.ClientID %>").val() == "") {
                toastr.warning("Please provide Payment Amount.");
                return false;
            }
            ...
            if (ddlPayMode == "Cash") {
             ...
             var ddlPaidByRegistrationIdText = $("#<%=txtChecqueNumber.ClientID %>").val();
                ...
                paymentDescription = $("#<%=ddlChequeBankId.ClientID %> option:selected").text() + ", Cheque No: " + $("#<%=txtChecqueNumber.ClientID %>").val();
    ...
    if (ddlPayMode == "Card") {
        ...
        var txtChequeBankId = $.trim($("#<%=ddlChequeBankId.ClientID %>").val());
        ...
        else if (txtChequeBankId == "0") {
            toastr.warning("Please select bank.");
            $("#txtChequeBankId").focus();
            return;
        }
    }
    else if ($("#ContentPlaceHolder1_ddlPayMode").val() == "Other Room") {
        if (ddlPaidByRegistrationId == "0") {
            toastr.warning('Please Select Guest Payment Room Number.');
            return;
        }
    }
    else if ($("#ContentPlaceHolder1_ddlPayMode").val() == "Employee") {
        if (ddlPaidByRegistrationId == "0") {
            toastr.warning('Please Select Employee Name.');
            return;
        }
    }
    else if ($("#ContentPlaceHolder1_ddlPayMode").val() == "Company") {
        if (ddlPaidByRegistrationId == "0") {
    ...
    var ddlCurrency = $("#<%=ddlCurrency.ClientID %>").val();
            ...
            var lcBankAccountHeadId = $("#<%=ddlLcBankAccountHead.ClientID %>").val();
            var lcBankAccountHead = $("#<%=ddlLcBankAccountHead.ClientID %> option:selected").text();
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-2">
                                                <asp:Label ID="Label13" runat="server" class="control-label" Text="Total LC Cost"></asp:Label>
                                            </div>
                                            <div class="col-md-10">
                                        ...
                                        <div id="AccountsPostingPanel">
                                            <div class="form-group" style="display: none;">
                                                <div class="col-md-2">
                                                    <asp:Label ID="lblReceiveAmount" runat="server" class="control-label" Text="Payment Amount"></asp:Label>
                                                </div>
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtReceiveAmount" runat="server" CssClass="form-control quantitydecimal" Enabled="false"></asp:TextBox>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-horizontal">
                                                    <div>
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <asp:Label ID="Label11" runat="server" class="control-label" Text="LC Bank Accounts"></asp:Label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <asp:DropDownList ID="ddlLcBankAccountHead" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <asp:Label ID="Label12" runat="server" class="control-label" Text="Bank Contributed"></asp:Label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <asp:HiddenField ID="hfBankAdjustmentTotalAmount" runat="server"></asp:HiddenField>
                                                                <asp:TextBox ID="txtBankContributeAmount" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <div class="form-group" style="display: none;">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <asp:DropDownList ID="ddlPayMode" runat="server" CssClass="form-control" TabIndex="5">
                                                                                    ...
                                                                                    <asp:ListItem Value="Cheque">Bank</asp:ListItem>
                                        ...
                                        <asp:GridView ID="gvItemDetail" Width="100%" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="ReservationId" Visible="False">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblReservationId" runat="server" Text='<%#Eval("LCDetailId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="gvOverheadDetail" Width="100%" runat="server" AllowPaging="True"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="ExpenseId" Visible="False">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblExpenseId" runat="server" Text='<%#Eval("ExpenseId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Over Head Name" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOverHeadName" runat="server" Text='<%#Eval("OverHeadName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="gvPaymentDetail" Width="100%" runat="server" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Account Head" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAccountHeadName" runat="server" Text='<%#Eval("AccountHeadName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:TemplateField>
