<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HMReport.Master" AutoEventWireup="true" CodeBehind="frmReportCustomerWiseSalesInformation.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesManagment.Reports.frmReportCustomerWiseSalesInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Customer Wise Sales</li>";
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">Report:: Customer Wise Sales Information </a>
        <div class="block-body collapse in">
            <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                PageCountMode="Actual" SizeToReportContent="true" ShowPrintButton="true" runat="server"
                Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                WaitMessageFont-Size="14pt" Width="950px" Height="820px">
                <%--<LocalReport ReportPath="SalesManagment\Reports\Rdlc\RptCustomerWiseSalesInformation.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="TransactionDataSource" Name="CustomerWiseSalesInformation" />
                    </DataSources>
                </LocalReport>--%>
            </rsweb:ReportViewer>
