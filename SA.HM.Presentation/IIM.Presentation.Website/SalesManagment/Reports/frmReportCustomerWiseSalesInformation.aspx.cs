...
{
    public partial class frmReportCustomerWiseSalesInformation : System.Web.UI.Page
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            {
                endDate = hmUtility.GetDateTimeFromString(txtEndDate.Text.Trim().ToString(), hmUtility.GetCurrentApplicationUserInfo().ServerDateFormat);
            }
            ...
            rvTransaction.LocalReport.DisplayName = "Customer Wise Sales";
            rvTransaction.LocalReport.Refresh();
        }
