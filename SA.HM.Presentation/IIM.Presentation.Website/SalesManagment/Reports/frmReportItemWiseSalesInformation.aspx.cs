...
{
    public partial class frmReportItemWiseSalesInformation : System.Web.UI.Page
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/SalesManagment/Reports/Rdlc/RptItemWiseSalesInformation.rdlc");
            ...
            rvTransaction.LocalReport.DisplayName = "Item Wise Sales";
            rvTransaction.LocalReport.Refresh();
