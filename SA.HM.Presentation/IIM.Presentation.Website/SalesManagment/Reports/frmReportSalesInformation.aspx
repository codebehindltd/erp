...
CodeBehind="frmReportSalesInformation.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesManagment.Reports.frmReportSalesInformation" %>
...
//            var txtEndDate = '<%=txtEndDate.ClientID%>'
            ...
            $("#ContentPlaceHolder1_txtStartDate").datepicker("option", {
                changeMonth: true,
                changeYear: true,
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">Report:: Date Wise Sales Information </a>
        <div class="block-body collapse in">
            <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                PageCountMode="Actual" SizeToReportContent="true" ShowPrintButton="true" runat="server"
                Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                WaitMessageFont-Size="14pt" Width="950px" Height="820px">
                <%--<LocalReport ReportPath="SalesManagment\Reports\Rdlc\RptSalesInformation.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="TransactionDataSource" Name="SalesInformation" />
                    </DataSources>
                </LocalReport>--%>
            </rsweb:ReportViewer>
