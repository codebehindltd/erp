<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="frmReportReceiptNPaymentStatement.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportReceiptNPaymentStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Receipt & Payment Statement</li>";
            ...
            if ($("#ContentPlaceHolder1_hfNotesNodes").val() != "") {
                ...
                var startDate = '', endDate = '', fiscalYearId = '0';
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <iframe id="printDocNotes" name="printDoc" width="100%" style="min-height: 300px" frameborder="0" style="overflow: hidden;"></iframe>
        </div>
    </div>
    <script type="text/javascript">
        $(document).ready(function () {
