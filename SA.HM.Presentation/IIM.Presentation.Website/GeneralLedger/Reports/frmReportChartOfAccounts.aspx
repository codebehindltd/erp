<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="frmReportChartOfAccounts.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportChartOfAccounts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">        
        <div class="panel-heading">
            Report:: Chart Of Accounts Information</div>
        <div class="panel-body">
            <asp:Panel ID="pnlReporContainer" runat="server" ScrollBars="Both" Height="700px">
                <rsweb:ReportViewer ID="rvTransaction" runat="server" PageCountMode="Actual" SizeToReportContent="true"
                    ShowFindControls="false" ShowWaitControlCancelLink="false" Width="950px" Height="820px"
    ...
    <script type="text/javascript">
        ...
        PrintOptionForReportViewerInMozillaChrome('<%= rvTransaction.ClientID%>');
    </script>
</asp:Content>
