<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HMReport.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="frmReportChequeList.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportChequeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Check List Statement</li>";
        ...
        function SearchTextForId() {
            $.ajax({
                ...
                url: "/GeneralLedger/Reports/frmReportGeneralLedger.aspx/FillForm",
            ...
            $('.ThreeColumnTextBox').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "/GeneralLedger/Reports/frmReportGeneralLedger.aspx/GetAutoCompleteData",
                        data: "{'searchText':'" + document.getElementById('txtSearch').value + "'}",
                        dataType: "json",
                        success: function (data) {
                            response(data.d);
            ...
            <div class="HMBodyContainer">
                ...
                <div style="display: none;">
                    ...
                    <div class="divSection">
                        ...
                        <div class="divBox divSectionLeftRight">
                            <input type="text" id="txtSearch" class="ThreeColumnTextBox" tabindex="6" />
                        </div>
                    </div>
                    <div class="divClear">
                    </div>
                ...
                <div class="divSection">
                    <div class="divBox divSectionLeftLeft">
                        <asp:Label ID="lblAccountHead" runat="server" Text="Bank Name"></asp:Label>
                    </div>
                    <div class="divBox divSectionLeftRight">
                        <asp:DropDownList ID="ddlAccountHead" CssClass="ThreeColumnDropDownList" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="divClear">
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">Report:: Check List
            Information </a>
        <div class="block-body collapse in">
            <asp:Panel ID="pnlReporContainer" runat="server" ScrollBars="Both" Height="700px">
                <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                    ...
                    <%--<LocalReport ReportPath="GeneralLedger\Reports\Rdlc\rptChequeListInfo.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="TransactionDataSource" Name="CheckListInfo" />
                        </DataSources>
                    </LocalReport>--%>
                </rsweb:ReportViewer>
                <%--<asp:ObjectDataSource ID="TransactionDataSource" runat="server" SelectMethod="GetData"
                    TypeName="HotelManagement.Presentation.Website.HotelManagementDBDataSetTableAdapters.GetCheckListInfoForReport_SPTableAdapter"
                    ...
                    <SelectParameters>
                        ...
                        <asp:FormParameter FormField="ddlNodeId" Name="NodeId" Type="Int32" />
                        ...
                        <asp:FormParameter FormField="ddlGLProject" Name="ProjectId" Type="String" />
                    </SelectParameters>
