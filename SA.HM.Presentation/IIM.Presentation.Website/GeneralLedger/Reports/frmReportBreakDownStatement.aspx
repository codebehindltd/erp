<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HMReport.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="frmReportBreakDownStatement.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportBreakDownStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Notes Break Down</li>";
    ...
    <div id="SearchPanel" class="block">
        <div class="row" style="padding-left: 30px">
            <div class="HMBodyContainer">
                ...
                <div class="divSection">
                    <div class="divBox divSectionLeftLeft">
                        <asp:Label ID="Label1" runat="server" Text="Notes Number"></asp:Label>
                    </div>
                    <div class="divBox divSectionLeftRight">
                        <asp:DropDownList ID="ddlNotesNumber" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="divClear">
        ...
        <div class="row">
            <div class="columnRight">
                ...
                <asp:TextBox ID="txtIsConfigurable" runat="server" Visible="False"></asp:TextBox>
            </div>
            <div class="clear">
            </div>
        </div>
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">Report:: Notes Breakdown
            Statement </a>
        <div class="block-body collapse in">
            <asp:Panel ID="pnlReporContainer" runat="server" ScrollBars="Both" Height="700px">
                <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                    ...
                    <%--<LocalReport ReportPath="GeneralLedger\Reports\Rdlc\RptNotesBreakdownStatement.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="TransactionDataSource" Name="NotesBreakdownStatement" />
                        </DataSources>
                    </LocalReport>--%>
                </rsweb:ReportViewer>
                <%--<asp:ObjectDataSource ID="TransactionDataSource" runat="server" SelectMethod="GetData"
                    TypeName="HotelManagement.Presentation.Website.HotelManagementDBDataSetTableAdapters.GetBreakdownStatementByNoteForReport_SPTableAdapter"
                    ...
                    <SelectParameters>
                        ...
                        <asp:FormParameter FormField="ddlNotesNumber" Name="NotesNumber" Type="String" />
                        <asp:FormParameter FormField="txtIsConfigurable" Name="IsConfigurable" Type="Int32" />
                    </SelectParameters>
