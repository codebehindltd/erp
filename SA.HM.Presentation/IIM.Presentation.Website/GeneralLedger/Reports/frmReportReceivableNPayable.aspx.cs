...
{
    public partial class frmReportReceivableNPayable : System.Web.UI.Page
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/GeneralLedger/Reports/Rdlc/RptReportBreakDownStatement.rdlc");
            ...
            string reportType = this.ddlReportType.SelectedItem.Text;           
            ...
            payOrReceiveBO = reportDA.GetPayableOrReceivableInfo(FromDate, ToDate, projectId, reportType);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], payOrReceiveBO));

            rvTransaction.LocalReport.DisplayName = "Payable/ Receivable";
