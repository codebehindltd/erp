...
{
    public partial class frmReportCashBookStatement : System.Web.UI.Page
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/GeneralLedger/Reports/Rdlc/RptCashBookStatement.rdlc");
            ...
            string nodeId = ddlNodeId.SelectedValue, project = ddlGLProject.SelectedValue, reportType = "Cash";
