<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HMReport.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="frmReportReceivableNPayable.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportReceivableNPayable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Receivable and Payable</li>";
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">Report:: Balance
            Sheet Statement </a>
        <div class="block-body collapse in">
            <div class="ReporContainerDiv">
                <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                    ...
                    <%--<LocalReport ReportPath="GeneralLedger\Reports\Rdlc\RptReportBreakDownStatement.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="TransactionDataSource" Name="BalanceSheetStatement" />
                        </DataSources>
                    </LocalReport>--%>
                </rsweb:ReportViewer>
                <%--<asp:ObjectDataSource ID="TransactionDataSource" runat="server" SelectMethod="GetData"
                    TypeName="HotelManagement.Presentation.Website.HotelManagementDBDataSetTableAdapters.GetBreakDownStatementInfoForReport_SPTableAdapter"
                    ...
                    <SelectParameters>
                        ...
                        <asp:FormParameter FormField="ddlReportType" Name="ReportType" Type="String" />
                    </SelectParameters>
