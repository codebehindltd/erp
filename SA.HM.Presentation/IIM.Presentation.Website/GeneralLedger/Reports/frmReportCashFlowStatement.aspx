<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="frmReportCashFlowStatement.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.Reports.frmReportCashFlowStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Cash Flow Statement</li>";
            ...
            if ($("#ContentPlaceHolder1_hfNotesNodes").val() != "") {
                ...
                var url = "/GeneralLedger/Reports/frmReportNotesBreakDownShow.aspx?rt=cf&sd=" + startDate + "&ed=" + endDate + "&st=" + searchType + "&fy=" + fiscalYearId
            ...
            $("#ContentPlaceHolder1_txtEndDate").blur(function () {
                ...
                if (date != "") {
                    ...
                    if (!isValid) {
                        ...
                        $("#ContentPlaceHolder1_txtEndDate").val(DayOpenDate);
                        return false;
                    }
                }
            });
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        ...
        <div class="panel-body">
            <asp:Panel ID="pnlReporContainer" runat="server" ScrollBars="Both" Height="700px">
                <div id="NoConfigurableBalanceSheet" style="overflow: scroll;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <iframe id="printDocNotes" name="printDoc" width="100%" frameborder="0" style="overflow: hidden;"></iframe>
        </div>
    </div>
    <script type="text/javascript">
        $(document).ready(function () {
