...
{
    public partial class frmReportBankBookStatement : System.Web.UI.Page
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/GeneralLedger/Reports/Rdlc/RptBankBookStatement.rdlc");
            ...
            string nodeId = ddlNodeId.SelectedValue, project = ddlGLProject.SelectedValue, reportType = "Bank";
            ...
            rvTransaction.LocalReport.DisplayName = "Bank Book Statement";
            ...
            //string ddl = ddlGLProject.SelectedValue;
            //if (!IsFormValid())
            //{
            //    return;
            //}
            ...
            //TransactionDataSource.SelectParameters[7].DefaultValue = "Bank";
            //rvTransaction.LocalReport.Refresh();
        }
        ...
        private bool IsFormValid()
        {
            bool status = true;
            int parse;
            if (this.ddlNodeId.SelectedIndex == 0)
            {
                this.isMessageBoxEnable = 1;
                lblMessage.Text = "Please Provide Account Head";
                status = false;
            }
            else if (!Int32.TryParse(this.ddlNodeId.SelectedValue, out parse))
            {
                this.isMessageBoxEnable = 1;
        ...
        public static List<string> GetAutoCompleteData(string searchText, string searchProjectId)
        {
            ...
            if (!string.IsNullOrWhiteSpace(searchProjectId))
            {
                ...
                nodeMatrixBOList = nodeMatrixDA.GetNodeMatrixInfoByProjectIdNCashOrBankOrSearchText(projectId, "Bank", searchText);
            }
