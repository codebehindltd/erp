<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="frmBudget.aspx.cs" Inherits="HotelManagement.Presentation.Website.GeneralLedger.frmBudget" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
            ...
            $("#txtSearch").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        url: 'frmBudget.aspx/GetAutoCompleteData',
        ...
        function GenerateForBudget() {
            ...
            PageMethods.FillForm(glCompanyId, glProjectId, fiscalYearId, nodeId, hierarchy, OnSucceedResult, OnError);
        }
        function OnSucceedResult(result) {
            Budget = result.budget;
            $("#generatedTable").html(result.budgetTable);
            $("#SaveContent").show();
        ...
        function SaveBudget() {
            ...
            PageMethods.SaveBudget(BudgetNew, BudgetDetails, OnSucceedSaveBudget, OnErrorSucceedSaveBudget);
        }
        ...
        function PopulateProjects(control) {
            ...
            $.ajax({
                type: "POST",
                url: "./frmBudget.aspx/GetBudgetType",
                data: JSON.stringify({ glCompanyId: companyId }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {                    
                    $("#lblBudgetType").text(CommonHelper.SplitPascalCaseToWord(response.d));
                },
                failure: function (response) {
                    toastr.error(response.d);
                }
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="overflow-x: scroll;">
                        <div id="generatedTable" style="width: 73.6vw;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="SaveContent">
                <div class="col-md-12">
                    <input type="button" value="Save Budget" class="TransactionalButton btn btn-primary btn-sm" onclick="SaveBudget()" />
                </div>
            </div>
        </div>
    </div>
