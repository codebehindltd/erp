...
{
    public partial class FixedAssetTransfer : System.Web.UI.Page
    {
        ...
        public static List<InvItemAutoSearchBO> ItemSearch(string searchTerm, int companyId, int projectId, int costCenterId, int categoryId, int locationId)
        {
            ...
            itemInfo = itemDa.GetAvailableFixedAssetItemForAutoSearch(searchTerm, companyId, projectId, costCenterId, categoryId, locationId);
            return itemInfo;
        }
        [WebMethod]
        ...
        [WebMethod]
        public static GridViewDataNPaging<PMProductOutBO, GridPaging> SearchOutOrder(string outType, DateTime? fromDate, DateTime? toDate, string issueNumber,
