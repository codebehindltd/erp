<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="FixedAssetReturn.aspx.cs" Inherits="HotelManagement.Presentation.Website.FixedAsset.FixedAssetReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#ContentPlaceHolder1_txtItem").autocomplete({
                ...
                source: function (request, response) {
                    var transferFor = $("#ContentPlaceHolder1_ddlTransferFor").val();
                    ...
                    $.ajax({
                        ...
                        url: '../FixedAsset/FixedAssetReturn.aspx/ItemSearch',
                        data: JSON.stringify({ transferFor: transferFor, outFor: outFor, searchTerm: request.term, companyId: companyId, projectId: projectId, costCenterId: costCenterId, categoryId: categoryId, locationId: locationId }),
                        dataType: "json",
            ...
            $("#txtSerialAutoComplete").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: '../FixedAsset/FixedAssetReturn.aspx/SerialSearch',
        ...
        function CreateNew() {
            ...
            $("#CreateNewDialog").dialog({
                ...
                height: 'auto',
                fluid: true,
                title: "Fixet Asset Return Information",
                show: 'slide'
            });
        ...
        function PerformClearAction() {
            ...
            $("#ContentPlaceHolder1_ddlEmployee").val("0").prop('disabled', false).trigger('change');
        ...
        function AddItemForTransfer() {
            ...
            TransferItemAdded.push({
                ...
                StockById: 1,//parseInt(ItemSelected.StockBy, 10),
        ...
        function SaveItemOutOrder() {
            ...
            var outOrderId = "0", issueType = "FixedAssetReturn", isEdited = "0", fromCostCenterId = "", fromLocationId = 0, toCostCenterId = 0,
            ...
            if (transferFor == 'employee')
                outFor = $("#ContentPlaceHolder1_ddlEmployee").val();
            else if (transferFor == 'department')
                outFor = $("#ContentPlaceHolder1_ddlDepartment").val();
        ...
        function LoadForEditOutOrder(result) {
            ...
            //    $("#ContentPlaceHolder1_ddlEmployee").val(result.ProductOut.OutFor).trigger('change');
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Button ID="btnCreateNew" runat="server" Text="New Fixed Asset Return" CssClass="TransactionalButton btn btn-primary btn-sm"
    ...
    <div id="CreateNewDialog" style="overflow: unset; display: none">
        <div class="form-horizontal">
            <div class="form-group">
                <div class="col-md-2">
                    <asp:Label ID="lblTransferFor" runat="server" class="control-label required-field" Text="Return From"></asp:Label>
                </div>
                <div class="col-md-4">
