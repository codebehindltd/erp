...
{
    public partial class SupportCallBillingInformation : BasePage
    {
        ...
        //[WebMethod]
        //public static ReturnInfo GenerateSupportBill(List<long> idList)
        //{
        ...
        //        status = supportDA.GenerateSupportBill(idList, userInformationBO.UserInfoId, "Generate");
        //        if (status)
        //        {
        ...
        [WebMethod]
        public static GridViewDataNPaging<STSupportBO, GridPaging> GetSupportCallBillingInformationForGridPaging(int clientId, int caseId, string caseNumber, string pFromDate, string pToDate, string billingStatus, int gridRecordsCount, int pageNumber, int isCurrentOrPreviousPage)
        {
            int totalRecords = 0;
            ...
            if (userInformationBO.EmpId != 0)
            {
                ...
                STSupportBOList = supportDA.GetSupportCallBillingInformationForGridPaging(userInformationBO.UserInfoId, empId, clientId, caseId, caseNumber, fromDate, toDate, billingStatus, userInformationBO.GridViewPageSize, pageNumber, out totalRecords);
            ...
            if (docList.Count > 0)
            {
                ...
                foreach (DocumentsBO dr in docList)
                {
                    if (dr.Extention == ".jpg" || dr.Extention == ".png")
                    {
                        ...
                        SupportCallBillingInformation supportCallInformation = new SupportCallBillingInformation();
