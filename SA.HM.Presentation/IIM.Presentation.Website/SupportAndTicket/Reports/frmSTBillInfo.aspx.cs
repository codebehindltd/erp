...
{
    public partial class frmSTBillInfo : System.Web.UI.Page
    {
        ...
        {
            string reportName = "rptSTBillingInvoice";
            ...
            if (!string.IsNullOrEmpty(queryStringId))
            {
                ...
                if (files[0].CompanyId > 0)
                {
                    ...
                    reportName = "rptSTBillingInvoice";
                ...
                billBO = billDA.GetSTBillInfoByBillId(billID);
                ...
                var reportPath = Server.MapPath(@"~/SupportAndTicket/Reports/Rdlc/" + reportName + ".rdlc");
                ...
                restaurantBill = rda.STPosBill(billID);
