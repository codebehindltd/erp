<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmDailyConsolidatedRevenueCostCenterSalesDetailByDineTime.aspx.cs"
    Inherits="HotelManagement.Presentation.Website.Inventory.Reports.frmDailyConsolidatedRevenueCostCenterSalesDetailByDineTime" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Dine Time Revenue</li>";
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">
        <div class="panel-heading">
            Report:: Daily Consolidated Revenue</div>
        <div class="panel-body">
