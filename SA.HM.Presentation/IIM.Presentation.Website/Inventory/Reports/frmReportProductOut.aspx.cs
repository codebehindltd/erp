...
{
    public partial class frmReportProductOut : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.ReportProcessing(Convert.ToInt32(outId));
                }                
            }
        }

        private void ReportProcessing(int outId)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Inventory/Reports/Rdlc/rptProductOut.rdlc");
