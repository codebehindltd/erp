...
{
    public partial class frmReportInvItemUsage : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Inventory/Reports/Rdlc/rptInventoryItemUsage.rdlc");
            ...
            string reportName = "Inventory Item Usage.";
            ...
            List<InventoryItemUsageViewBO> invItemUsageList = new List<InventoryItemUsageViewBO>();
            invItemUsageList = allInventoryReportDA.GetInventoryItemUsage(FromDate, ToDate, categoryId, itemId, locationId);

            var reportDataSet = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataSet[0], invItemUsageList));
