<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmInventoryItemUsageAnalysis.aspx.cs" Inherits="HotelManagement.Presentation.Website.Inventory.Reports.frmInventoryItemUsageAnalysis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Item Usage Analysis</li>";
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">
        <div class="panel-heading">
            Report:: Inventory Item Usage Analysis</div>
        <div class="panel-body">
