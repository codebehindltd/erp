...
{
    public partial class frmReportInvStockVariance : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Inventory/Reports/Rdlc/rptInventoryStockVariance.rdlc");
            ...
            string reportName = "Inventory Stock Variance";
            ...
            List<InventoryStockVarianceViewBO> invStockVarianceList = new List<InventoryStockVarianceViewBO>();
            invStockVarianceList = allInventoryReportDA.GetInventoryStockVariance(FromDate, ToDate, categoryId, itemId, locationId);

            var reportDataSet = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataSet[0], invStockVarianceList));
