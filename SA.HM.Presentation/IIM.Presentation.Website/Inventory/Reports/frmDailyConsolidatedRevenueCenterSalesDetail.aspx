<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmDailyConsolidatedRevenueCenterSalesDetail.aspx.cs" Inherits="HotelManagement.Presentation.Website.Inventory.Reports.frmDailyConsolidatedRevenueCenterSalesDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Consolidated Revenue</li>";
