...
{
    public partial class frmReportrptConsolidatedMenuItemSalesSummary : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Inventory/Reports/Rdlc/rptConsolidatedMenuItemSalesDetail.rdlc");
            ...
            string reportName = "Consolidated Sales Detail";
            ...
            invVarianceInfo = allInventoryReportDA.GetConsolidatedMenuItemSalesDetailBO(FromDate, ToDate);
