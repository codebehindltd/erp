...
{
    public partial class frmInventoryItemUsageAnalysis : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/Inventory/Reports/Rdlc/rptInventoryItemUsageAnalysis.rdlc");
            ...
            invVarianceInfo = allInventoryReportDA.GetInventoryItemUsageAnalysis(FromDate, ToDate);

            if (invVarianceInfo.Count == 0)
            {
                invVarianceInfo = new List<InventoryItemUsageAnalysisBO>();
            }
