<%@ Page Title="" Language="C#" MasterPageFile="~/Common/ReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmReportProductionInfo.aspx.cs" Inherits="HotelManagement.Presentation.Website.Inventory.Reports.frmReportProductionInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Finished Goods Information</li>";
    ...
    <div style="display: none;">
        <asp:Button ID="btnEmailSend" runat="server" Text="Send Email" Style="margin-left: 630px;
            background-color: #286090; color: White; padding: 5px;" TabIndex="10" OnClick="btnEmailSend_Click"
            ClientIDMode="Static" />
