                                                              ...
                                                              List<PMProductSerialInfoBO> DeletedSerialzableProduct, int randomDocId, string deletedDoc)
        {
            ...
            try
            {
                ...
                if (ProductReceive.ReceivedId == 0)
                {
                    ...
                    rtninfo.IsSuccess = receiveDA.SaveProductReceiveInfo(ProductReceive, ReceiveOrderItem, ItemSerialDetails, isApprovalProcessEnable, out receiveId, out TransactionNo, out TransactionType, out ApproveStatus);
                ...
                else
                {
                    ...
                    rtninfo.IsSuccess = receiveDA.UpdateProductReceiveInfo(ProductReceive, ReceiveOrderItem, EditedReceivedDetails, ReceiveOrderItemDeleted, ItemSerialDetails, DeletedSerialzableProduct, out TransactionNo, out TransactionType, out ApproveStatus);
