<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmBanquetBillSearch.aspx.cs" Inherits="HotelManagement.Presentation.Website.Banquet.frmBanquetBillSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Restaurant Bill Search</li>";
...
function OnProjectsPopulated(response) {
    var ddlGLProject = '<%=ddlGLProject.ClientID%>'
        ...
        function GridPaging(pageNumber, IsCurrentOrPreviousPage) {
            ...
            PageMethods.SearchBillAndLoadGridInformation(searchDate, billNo, gridRecordsCount, pageNumber, IsCurrentOrPreviousPage, OnSuccess, OnFail);
            return false;
        }
        function OnSuccess(result) {
            ...
            $.each(result.GridData, function (count, gridObject) {
                ...
                if (gridObject.IsDayClosed == 0) {
                    ...
                    editBill = "";
                    var resettlementBill = "&nbsp;&nbsp;<img id='preview' src='../Images/billresettlement.png' onClick= \"javascript:return BillReSettlement('" + gridObject.Id + "')\" alt='Re Sattlement' Title='Bill Re-Settlement' border='0'/>";


                    if (gridObject.BillStatus == "Active") {
                        tr += "<td id='Cancel' align='centre' style=\"width:15%; cursor:pointer;\">";
                        ...
                        tr += "<td align='centre' style=\"width:15%; cursor:pointer;\">";
                        if ($("#<%=hfIsUpdatePermission.ClientID %>").val() == "1") {
                            tr += editBill;
                            tr += resettlementBill
                        }
                    ...
                    tr += "<td id='Cancel' align='centre' style=\"width:15%; cursor:pointer;\"><img id='preview' src='../Images/ReportDocument.png' onClick= \"javascript:return PerformBillPreviewAction('" + gridObject.Id + "')\" alt='Preview Bill' Title='Preview' border='0'/></td>";
                }
        ...
        function OnUpdateSuccess(result) {
            var possiblePath = "frmBanquetBillSearch.aspx";
        ...
        function OnLoadEditDataSucceeded(result) {
            ...
            //popup(1, "GuestBillPaymentDialog", "", 900, 500);
        ...
        function BillReSettlement(billId) {
            var possiblePath = "/Banquet/frmBanquetBillSettlement.aspx?ReSettlement=" + billId;
            window.location = possiblePath;
        }
    </script>
