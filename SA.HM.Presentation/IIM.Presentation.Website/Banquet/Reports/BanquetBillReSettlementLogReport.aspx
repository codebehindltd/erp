<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="BanquetBillReSettlementLogReport.aspx.cs" Inherits="HotelManagement.Presentation.Website.Banquet.Reports.BanquetBillReSettlementLogReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">        
            <div class="panel-heading">Report:: Banquet Re-Settlement Information</div>
        <div class="panel-body">
