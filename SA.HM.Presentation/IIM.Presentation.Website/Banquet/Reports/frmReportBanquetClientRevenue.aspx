<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportBanquetClientRevenue.aspx.cs" Inherits="HotelManagement.Presentation.Website.Banquet.Reports.frmReportBanquetClientRevenue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Banquet Client Revenue</li>";
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">
            Report:: Banquet Client Revenue Information</div>
        <div class="panel-body">
