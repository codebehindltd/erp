<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmBanquetBillSettlement.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.frmBanquetBillSettlement" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($("#<%=hfparticipantFromOfficeValue.ClientID %>").val() != "") {
                console.log($("#<%=hfparticipantFromOfficeValue.ClientID %>").val());
                $("#ContentPlaceHolder1_ddltxtParticipantFromOffice1").val($("#<%=hfparticipantFromOfficeValue.ClientID %>").val());
                var arrayArea = $("#<%=hfparticipantFromOfficeValue.ClientID %>").val().split(',');
                $("#ContentPlaceHolder1_ddltxtParticipantFromOffice1").select2({
                    multiple: true,
                });
                $('#ContentPlaceHolder1_ddltxtParticipantFromOffice1').val(arrayArea).trigger('change');
            ...
            $('#ContentPlaceHolder1_ddlParticipantFromClient1').select2({
                multiple: true,
            });
            ...
            $('#ContentPlaceHolder1_ddlCompany1').select2({
                multiple: false,
            })
            ...
            //$("#ContentPlaceHolder1_ddltxtParticipantFromOffice1 :selected").each(function () {
            //    participantFromOffice.push({
            //        ContactId: $(this).val(),
            //        Contact: $(this).text()
            //    });
            ...
            $("#ContentPlaceHolder1_ddlParticipantFromClient1 :selected").each(function () {
                salesCallParticipantFromClient.push({
                    ContactId: $(this).val(),
                    Contact: $(this).text()
                });
            ...
            //$("#ContentPlaceHolder1_ddlCompany :selected").each(function () {
            //    company.push({
            //        CompanyId: $(this).val(),
            ...
            $("#ContentPlaceHolder1_ddlParticipantFromClient1").val(salesCallParticipantFromClient).trigger('change');
            /* $("#ContentPlaceHolder1_ddltxtParticipantFromOffice1").val(participantFromOffice).trigger('change');*/
            ...
            $("#<%=txtDiscountAmount.ClientID %>").blur(function () {
                var checkValue = CheckDiscountValidationForFixedRPercentage($("#ContentPlaceHolder1_ddlDiscountType"), $("#ContentPlaceHolder1_txtDiscountAmount"), $("#ContentPlaceHolder1_txtGrandTotal"), "Rebate Amount");
                if (checkValue == false) {
            ...
            $("#<%=ddlCompany1.ClientID %>").change(function () {
                console.log($('#<%=ddlCompany1.ClientID%>').val());
                var option = new Option("", "", false, false);
                //$('#ContentPlaceHolder1_ddlParticipantFromClient').val(null).trigger('change');
                $('#ContentPlaceHolder1_ddlParticipantFromClient1').empty().trigger("change");
                $.ajax({
                    type: "POST",
                    url: "/Banquet/frmBanquetBillSettlement.aspx/GetContactInformationByCompanyId",
                    data: '{companyId: ' + $('#<%=ddlCompany1.ClientID%>').val() + '}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: OnContactPopulated1,
            ...
            function OnContactPopulated1(response) {
                console.log(response.d);
                var contactArray = new Array();

                for (var d = 0; d < response.d.length; d++) {
                    var item = response.d[d];
                    ...
                    //$("#ContentPlaceHolder1_ddlParticipantFromClient").append(option);
                    $("#ContentPlaceHolder1_ddlParticipantFromClient1").append(option).trigger('change');

                    console.log(item.Id);
                    console.log(item.Name);
                }
                //$("#ContentPlaceHolder1_ddlParticipantFromClient").val([]).change();
            }


            $("#<%=ddlCompany.ClientID %>").change(function () {
                console.log($('#<%=ddlCompany.ClientID%>').val());
                var option = new Option("", "", false, false);
                //$('#ContentPlaceHolder1_ddlParticipantFromClient').val(null).trigger('change');
                $('#ContentPlaceHolder1_ddlParticipantFromClient').empty().trigger("change");
                $.ajax({
                    type: "POST",
                    url: "/Banquet/frmBanquetBillSettlement.aspx/GetContactInformationByCompanyId",
                    data: '{companyId: ' + $('#<%=ddlCompany.ClientID%>').val() + '}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: OnContactPopulated,
                    failure: function (response) {
                        alert(response.d);
                    }
                });
            ...
            function OnContactPopulated(response) {
                console.log(response.d);
                var contactArray = new Array();
                ...
                for (var d = 0; d < response.d.length; d++) {
                    ...
                    //$element.append(option);
                    //$("#ContentPlaceHolder1_ddlParticipantFromClient").append(option);
                    $("#ContentPlaceHolder1_ddlParticipantFromClient").append(option).trigger('change');
            ...
            $("#btnBillPrintPreview").click(function () {
                ...
                var url = '/Banquet/Reports/frmReportReservationBillInfo.aspx?Id='
            ...
            $("#btnAddDetailItem").click(function () {
                ...
                if ($("#<%=txtItemArrivalTime.ClientID %>").val() == "") {
                    ...
                    toastr.warning("Please Provide Item Arrival time.");
                    add = false;
                    return;
                }
                if ($("#<%=txtItemUnit.ClientID %>").val() != "") {
            ...
            var hfDue = parseFloat($("#<%=hfDueAmount.ClientID %>").val());
            if (hfDue <= 0) {
                $('#ContentPlaceHolder1_btnSave').attr('disabled', false);
            }
            else {
        ...
        function DivShowHideForEventType(type) {
            if (type == "Internal") {
                ...
                $(".DivShowClient").show();
                $("#Div2").hide();
                $("#ContentPlaceHolder1_GuestPaymentDetailsInformationDiv").hide();
                $("#btnFinishDiv").show();
                $("#<%=lblSalesTotalLocal.ClientID %>").text("Total Amount");
                $("#MeetingDiscussionAndCallToActionDiv").show();
                $("#ParticipantFromOfficeDiv").show();
                $("#ParticipantCompanyDiv").show();
                $("#ParticipantFromClientDiv").show();
            }
            else {
                $(".DivHideForEventType").show();
                $("#Div2").show();
                $("#ContentPlaceHolder1_GuestPaymentDetailsInformationDiv").show();
                $("#btnFinishDiv").hide();
                $("#<%=lblSalesTotalLocal.ClientID %>").text("Sales Amount");
                $(".DivShowClient").hide();
                $("#MeetingDiscussionAndCallToActionDiv").hide();
                $("#ParticipantFromOfficeDiv").hide();
                $("#ParticipantCompanyDiv").hide();
                $("#ParticipantFromClientDiv").hide();
            }
        }
        function AddItemDetailsInfo(id, reservationId) {
            ...
            if ($('#' + unitPrice).val() != 0) {
                ...
                table += "<td align='left' style=\"width:10%; text-align:Left;\">" + itemArrivalTime + "</td>";
                table += "<td align='left' style=\"width:15%; text-align:Left;\">" + itemDescription + "</td>";
                table += "<td align='left' style=\"display:none;\">" + isComplementary + "</td>";
        ...
        function AddNewRow(id, reservationId, itemTypeId, itemId, unitPrice, itemUnit, calculatedAmount) {
            ...
            tr += "<td align='left' style=\"width:10%; text-align:Left;\">" + itemArrivalTime + "</td>";
            tr += "<td align='left' style=\"width:15%; text-align:Left;\">" + itemDescription + "</td>";
        ...
        function SaveGuestPaymentDetailsInformationByWebMethod() {
            ...
            var hfPaid = $("#<%=HiddenFieldTotalPaid.ClientID %>").val();
            var hfDue = $("#<%=hfDueAmount.ClientID %>").val();

            var GrandTotal = parseFloat(txtGrandTotal);
            var Paying = parseFloat(Amount);
            ...
            if ($("#<%=txtReceiveLeadgerAmount.ClientID %>").val() == "") {
                ...
                $("#<%=txtReceiveAmount.ClientID %>").focus();
                return false;
            }
            if (ddlPayMode == "0") {
            ...
            if (ddlPayMode == "Cash") {
                ...
                <%--if (Paying > GrandTotal) {
                    toastr.warning("You have entered more amount than total amount to be paid.");
                    $("#<%=txtReceiveLeadgerAmount.ClientID %>").focus();
                    return false;
                }
                else if ((Paying > hfDue) && (hfDue != "")) {
                    toastr.warning("You have entered more amount than Due amount to be paid.");
                    $("#<%=txtReceiveLeadgerAmount.ClientID %>").focus();
                    return false;
                }--%>
            }
            ...
            var ddlCardTypeText = $("#<%=ddlCardType.ClientID %> option:selected").text();
                ...
                else if (ddlBankId == null) {
                    //toastr.info("hello " + ddlBankId);
                    toastr.warning('Please Select Bank Name.');
                    $("#txtBankId").focus();
                    return;
                }
    ...
    if (ddlPayMode == "Cheque") {
        var ddlCompanyName = $('#<%=ddlCompanyName.ClientID%>').val();
                ...
                else if (ddlChequeBankId == "") {
                    toastr.warning("Please provide Bank Name.");
                    $("#txtChequeBankId").focus();
                    return false;
                }
            ...
            var bankName = $("#<%=ddlChequeBankId.ClientID %> option:selected").text();
                var checqNumber = $("#<%=txtChecqueNumber.ClientID %>").val();

                paymentDescription = bankName + " , Cheque No.: " + checqNumber;
        ...
        function OnPerformGetTotalPaidAmountSucceeded(result) {
            ...
            $("#<%=hfDueAmount.ClientID %>").val(dueAmountTotal);
        ...
        function ClearDetailsPart() {
            ...
            $("#<%=ddlChequeBankId.ClientID %>").val('0');
        ...
        function OfficeNClient() {

            console.log("OfficeNClient()");
            var participantFromOfficeValue = $("#<%=ddltxtParticipantFromOffice1.ClientID %>").val();
            ...
            //$("#<%=ddltxtParticipantFromOffice.ClientID %>").val(employeeIdArray);
            //$("#<%=ddltxtParticipantFromOffice.ClientID %>").select2('val', employeeIdArray);
            ...
            //$('#ContentPlaceHolder1_ddltxtParticipantFromOffice').select2('val', "7,8");
            $('#ContentPlaceHolder1_ddltxtParticipantFromOffice1').val(arrayArea).trigger('change');



            var participantFromClientValue = $("#<%=ddlParticipantFromClient1.ClientID %>").val();
            var participantFromClientValueStr = participantFromClientValue.join(",");
            $("#<%=hfparticipantFromClientValue.ClientID %>").val(participantFromClientValueStr);


                <%--var clientIdArray = $("#ContentPlaceHolder1_hfparticipantFromClientValue").val();
                //$("#<%=ddltxtParticipantFromOffice.ClientID %>").val(employeeIdArray);
                //$("#<%=ddltxtParticipantFromOffice.ClientID %>").select2('val', employeeIdArray);
                var clientArrayArea = clientIdArray.split(',');--%>
            ...
            //});
            ////$('#ContentPlaceHolder1_ddltxtParticipantFromOffice').select2('val', "7,8");
            //$('#ContentPlaceHolder1_ddlParticipantFromClient1').val(clientArrayArea).trigger('change');

            var meetingDiscussion = $("#<%=txtMeetingDiscussion1.ClientID %>").val();
            var officeparticipantno = $("#<%=hfparticipantFromOfficeValue.ClientID %>").val();
            var clientparticipantno = $("#<%=hfparticipantFromClientValue.ClientID %>").val();
            var company = $('#<%=ddlCompany1.ClientID%>').val();

            if (meetingDiscussion == "") {
                toastr.warning("Please Insert Meeting Discussion.");
                $("#ContentPlaceHolder1_txtMeetingDiscussion1").focus();
                return false;
            }

            if (company != 0 && clientparticipantno == "") {
                toastr.warning("Please select Participant From Client.");
                $("#ContentPlaceHolder1_ddlParticipantFromClient1").focus();
                return false;
            }

            if (officeparticipantno == "" && clientparticipantno == "") {
                toastr.warning("Please select Participant From Office.");
                $("#ContentPlaceHolder1_ddltxtParticipantFromOffice1").focus();
                return false;
            }
            ...
            $("#ltlTableWiseItemInformation > table tbody tr").each(function () {
                ...
                itemArrivalTime = $(this).find("td:eq(9)").text();
                itemDescription = $(this).find("td:eq(10)").text();
                isComplementary = $(this).find("td:eq(11)").text();
    ...
    <div class="form-group" id="BillPreviewRelatedInformation" style="display: none; padding-top: 10px;">
        <div class="col-md-2">
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2">
                        <asp:Label ID="lblSrcRoomNumber" runat="server" class="control-label" Text="Reservation Number"></asp:Label>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div id="myTabs">
                        <ul id="tabPage" class="ui-style">
                            ...
                            <li id="C" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                                href="#tab-3">Requisite Details</a></li>
                        </ul>
                        <div id="tab-1">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-2">
                                                <asp:Label ID="lblddlBanquetId" runat="server" class="control-label" Text="Hall Name"></asp:Label>
                                            </div>
                                            <div class="col-md-10">
                                                <asp:TextBox ID="txtBanquetId" runat="server" CssClass="form-control" ReadOnly="true">0</asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group DivHideForEventType">
                                            <div class="col-md-2">
                                                <asp:Label ID="lblBanquetRate" runat="server" class="control-label" Text="Rate"></asp:Label>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtBanquetRate" runat="server" CssClass="form-control" ReadOnly="true">0</asp:TextBox>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:Label ID="lblddlSeatingId" runat="server" class="control-label" Text="Seating Plan"></asp:Label>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtSeatingId" runat="server" CssClass="form-control" ReadOnly="true">0</asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group DivHideForEventType">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtSDCharge" runat="server" CssClass="form-control" Enabled="false">0</asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:HiddenField ID="hfDueAmount" runat="server"></asp:HiddenField>
                                            ...
                                            <div class="col-md-6">
                                                <div id="pnlBillPrintPreview" runat="server">

                                                    <input type="button" id="btnAddMoreItem" value="Add More Item" class="TransactionalButton btn btn-primary btn-sm" />
                                                    &nbsp;
                                                    <input type="button" id="btnBillPrintPreview" value="Bill Preview" class="btn btn-primary btn-sm DivHideForEventType" />
                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-2">
                                                                    <asp:Label ID="lblRebateRemarks" runat="server" class="control-label" Text="Discount Details"></asp:Label>
                                                                </div>
                                                                <div class="col-md-10">
                                        ...
                                        <div id="GuestPaymentDetailsInformationDiv" runat="server" class="panel panel-default">
                                            <div class="panel-body">
                                                <div class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-horizontal">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <asp:DropDownList ID="ddlPayMode" runat="server" CssClass="form-control" TabIndex="5">
                                                                                ...
                                                                                <asp:ListItem Enabled="false" Value="Employee">Employee</asp:ListItem>
                                                                    ...
                                                                    <div id="GuestPaymentDetailGrid" runat="server" clientidmode="Static" class="childDivSection">
                                                                    </div>
                                                                    <div id="TotalPaid" runat="server" clientidmode="Static" class="totalAmout">
                                                                    </div>
                                                                    <div id="dueTotal" runat="server" clientidmode="Static" class="totalAmout">
                                                                    </div>
                                                                    <div>
                                                    ...
                                                    <div class="form-group" id="MeetingDiscussionAndCallToActionDiv" style="display: none;">
                                                        <div class="col-md-2">
                                                            <label class="control-label required-field">Meeting Discussion</label>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <textarea id="txtMeetingDiscussion" class="form-control" rows="5" cols="30" runat="server"></textarea>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label class="control-label">Call To Action</label>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <textarea id="txtCallToAction" class="form-control" rows="5" cols="30" runat="server"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="ParticipantFromOfficeDiv" style="display: none;">
                                                        <div class="col-md-2">
                                                            <label class="control-label required-field" style="text-align: left;">Participant From Office</label>
                                                        </div>
                                                        <div class="col-md-10">
                                                    ...
                                                    <div class="form-group" id="ParticipantCompanyDiv" style="display: none;">
                                                        <div class="col-md-2">
                                                    ...
                                                    <div class="form-group" id="ParticipantFromClientDiv" style="display: none;">
                                                        <div class="col-md-2">
                                                            <label class="control-label required-field" style="text-align: left;">Participant From Client</label>
                                                        </div>
                                                        <div class="col-md-10">
                                        ...
                                        <div class="DivShowClient" style="display: none">
                                            <div class="form-group">
                                                <div class="col-md-2">
                                                    <label class="control-label required-field">Meeting Discussion</label>
                                                </div>
                                                <div class="col-md-4">
                                                    <textarea id="txtMeetingDiscussion1" class="form-control" rows="5" cols="30" runat="server"></textarea>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="control-label">Call To Action</label>
                                                </div>
                                                <div class="col-md-4">
                                                    <textarea id="txtCallToAction1" class="form-control" rows="5" cols="30" runat="server"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddltxtParticipantFromOffice1" TabIndex="1" name="states[]" multiple="multiple" CssClass="form-control" runat="server" Style="width: 100%;">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <%-- <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <asp:DropDownList ID="ddlCompany" TabIndex="1" name="states[]" multiple="multiple" CssClass="form-control" runat="server" Style="width: 100%;"></asp:DropDownList>
                                                        </div>
                                                    </div>--%>
                                            <div class="form-group">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:DropDownList ID="ddlCompany1" TabIndex="1" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:DropDownList ID="ddlParticipantFromClient1" TabIndex="1" name="states[]" multiple="multiple" CssClass="form-control" runat="server" Style="width: 100%;">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group" id="btnFinishDiv" style="display: none">
                                            <div class="col-md-2">
                                                <asp:Button ID="btnFinish" runat="server" TabIndex="13" Text="Finish" CssClass="TransactionalButton btn btn-primary btn-sm"
                                                    OnClick="btnFinish_Click" OnClientClick="javascript:return OfficeNClient();" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <asp:GridView ID="gvItemDetail" Width="100%" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="ReservationId" Visible="False">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblReservationId" runat="server" Text='<%#Eval("ReservationId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Total Price">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblServiceCharge" runat="server" Text='<%# Bind("TotalPrice") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <ItemStyle Width="10%"></ItemStyle>
                                                </asp:TemplateField>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-horizontal">
                                                    <div id="ItemDetails">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <asp:Label ID="Label9" runat="server" class="control-label required-field" Text="Delivery Time"></asp:Label>
                                                            </div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <asp:Label ID="Label10" runat="server" class="control-label" Text="Description"></asp:Label>
                                                            </div>
                                                            <div class="col-md-10">
                        ...
                        <div id="tab-3">
                            <div id="Div1" class="panel panel-default">
                                <div class="panel-heading">
                                    Requisite Detail Information
                                </div>
                                <div class="panel-body">
                                    <div>
                                        <asp:Label ID="Label2" runat="server" class="control-label" Text='' Visible="False"></asp:Label>
                                        <asp:GridView ID="gvRequisitesDetail" Width="100%" runat="server" AllowPaging="True"
