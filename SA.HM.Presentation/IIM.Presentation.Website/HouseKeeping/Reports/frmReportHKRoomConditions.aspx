<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportHKRoomConditions.aspx.cs" Inherits="HotelManagement.Presentation.Website.HouseKeeping.Reports.frmReportHKRoomConditions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Room Condition</li>";
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlRoomType" runat="server" CssClass="form-control" TabIndex="1">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlHKStatus" runat="server" CssClass="form-control" TabIndex="2">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row">
