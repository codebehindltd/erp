<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Common/Innboard.Master"
    CodeBehind="frmReportHKRoomStatistics.aspx.cs" Inherits="HotelManagement.Presentation.Website.HouseKeeping.Reports.frmReportHKRoomStatistics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Room Statistics</li>";
