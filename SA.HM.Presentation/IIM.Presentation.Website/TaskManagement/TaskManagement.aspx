<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="TaskManagement.aspx.cs" Inherits="HotelManagement.Presentation.Website.TaskManagement.Task_Management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "./TaskManagementIfreame.aspx";
