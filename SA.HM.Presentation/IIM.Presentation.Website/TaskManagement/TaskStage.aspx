<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="TaskStage.aspx.cs" Inherits="HotelManagement.Presentation.Website.TaskManagment.TaskStage" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            StageTable = $("#tblSatge").DataTable({
                data: [],
                columns: [
                    { title: "Task Stage", "data": "TaskStage", sWidth: '30%' },
        ...
        function SaveOrUpdateStage() {
            ...
            if (TaskStage == "") {
                toastr.warning("Enter Task Stage");
            ...
            PageMethods.DuplicateCheckDynamicaly("TaskStage", TaskStage, IsUpdate, id, DuplicateCheckDynamicalySucceed, DuplicateCheckDynamicalyFailed);
            return false;
        ...
        function DuplicateCheckDynamicalySucceed(result) {
            ...
            if (result > 0) {
                toastr.warning("Duplicate Task Stage");
                $("#ContentPlaceHolder1_txtTaskStage").focus();
                return false;
            }
            else {
        ...
        function OnSuccessLoad(result) {
            if (!confirm("Do you want to edit - " + result.TaskStage + "?")) {
                return false;
            }
            $("#CreateNewDialog").dialog({
                autoOpen: true,
                ...
                height: 'auto',
                fluid: true,
                title: "Update Task Stage - " + result.TaskStage,
                show: 'slide'
            });
            $("#ContentPlaceHolder1_hfStageId").val(result.Id);
            $("#ContentPlaceHolder1_txtTaskStage").val(result.TaskStage);
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-md-2">
                        <label class="control-label">Task Stage</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:Button ID="btnCreateNew" runat="server" TabIndex="4" Text="New Task Stage" CssClass="TransactionalButton btn btn-primary btn-sm"
