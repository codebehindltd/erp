<%@ Page Title="" Language="C#" MasterPageFile="~/Common/ReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmReportJobCircularDetails.aspx.cs" Inherits="HotelManagement.Presentation.Website.Recruitment.Reports.frmReportJobCircularDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ReportPanel" class="block" style="display: none;">
        <%--<a href="#page-stats" class="block-heading" data-toggle="collapse">Job Circular</a>--%>
