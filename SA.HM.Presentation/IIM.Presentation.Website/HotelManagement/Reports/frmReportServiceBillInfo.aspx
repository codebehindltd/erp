<%@ Page Title="" Language="C#" MasterPageFile="~/Common/ReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmReportServiceBillInfo.aspx.cs" Inherits="HotelManagement.Presentation.Website.Restaurant.Reports.frmReportServiceBillInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display: none;">
        <asp:Button ID="btnPrintReportTemplate1" runat="server" Text="template1" OnClick="btnPrintReportTemplate1_Click"
            ClientIDMode="Static" />
        <asp:Button ID="btnPrintReportTemplate2" runat="server" Text="template2" OnClick="btnPrintReportTemplate2_Click"
            ClientIDMode="Static" />
        <asp:Button ID="btnPrintReportTemplate3" runat="server" Text="template3" OnClick="btnPrintReportTemplate3_Click"
            ClientIDMode="Static" />
        <asp:Button ID="btnPrintReportTemplate4" runat="server" Text="template4" OnClick="btnPrintReportTemplate4_Click"
            ClientIDMode="Static" />
    </div>
    <iframe id="frmPrint" name="IframeName" width="0" height="0" runat="server" style="left: -1000;
        top: 2000;" clientidmode="static"></iframe>
    <div>
        <div id="ReportPanel" class="block" style="width: 810px; height: 500px;">
            <div style="overflow-x: scroll; overflow-y: scroll;">
                <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvTransaction"
                    PageCountMode="Actual" SizeToReportContent="true" ShowPrintButton="true" runat="server"
                    Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                    WaitMessageFont-Size="14pt" Width="950px" Height="820px" ShowPageNavigationControls="false">
                </rsweb:ReportViewer>
            </div>
        </div>
    </div>
    <script type="text/javascript">
        ...
        function PrintDocumentFunc(printTemplate) {
            ...
            else if (printTemplate == "4") {
                $("#btnPrintReportTemplate4").trigger('click');
            }
            return true;
        }
