<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportRoomWiseStatus.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.Reports.frmHMReportViewer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Room Wise Status</li>";
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">                       
                        <asp:DropDownList ID="ddlRoomStatus" CssClass="form-control" runat="server">
                            ...
                            <asp:ListItem>Expected Departure</asp:ListItem>
                            <asp:ListItem>Occupied</asp:ListItem>
                            <asp:ListItem>Vacant Dirty</asp:ListItem>
