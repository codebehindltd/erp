<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportHouseKeeping.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.Reports.frmReportHouseKeeping" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="SearchPanel" class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2">
                        <asp:Label ID="lblLastCleanDate" runat="server" class="control-label" Text="Last Clean Date"></asp:Label>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSrcLastCleanDate" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlRoomStatus" CssClass="form-control" runat="server">
                            ...
                            <asp:ListItem Value="2">Inhouse</asp:ListItem>
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">
            Report:: House Keeping Information</div>
        <div class="panel-body">
            <div class="ReporContainerDiv">
                <asp:Panel ID="pnlRoomCalender" runat="server" ScrollBars="Both" Height="700px">
                    <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvRoomStatusInfoByDate"
                        ...
                        <%--<LocalReport ReportPath="HotelManagement\Reports\Rdlc\rptHouseKeeping.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="HouseKeepingInfoDataSource" Name="HouseKeepingInfo" />
                            </DataSources>
                        </LocalReport>--%>
                    </rsweb:ReportViewer>
                    <%--<asp:ObjectDataSource ID="HouseKeepingInfoDataSource" runat="server" SelectMethod="GetData"
                        TypeName="HotelManagement.Presentation.Website.HotelManagementDBDataSetTableAdapters.GetRoomNumberInfoByCleanup_SPTableAdapter"
                        ...
                        <SelectParameters>
                            ...
                            <asp:FormParameter FormField="ddlCleanStatus" Name="Cleanup" Type="String" />
                            <asp:FormParameter FormField="txtRoomNumber" Name="RoomNumber" Type="String" />
                        </SelectParameters>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if (CommonHelper.BrowserType().mozilla || CommonHelper.BrowserType().chrome) {
                ...
                var barControlId = CommonHelper.GetReportViewerControlId($("#<%=rvRoomStatusInfoByDate.ClientID %>"));
