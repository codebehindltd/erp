<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportBCRoomSalesRevenue.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.Reports.frmReportBCRoomSalesRevenue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Bar Chart Room Sales Revenue</li>";
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">       
            ...
            Room Sales Revenue Information</div>
        <div class="panel-body">
