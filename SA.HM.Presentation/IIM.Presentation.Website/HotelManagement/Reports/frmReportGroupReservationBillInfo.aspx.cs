...
{
    public partial class frmReportGroupReservationBillInfo : System.Web.UI.Page
    {
        //**************************** Handlers ****************************//
        ...
        private void LoadReport()
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptGroupReservationConfirmationLetter.rdlc");
            ...
            int billID = Int32.Parse(reservationId);
            this.txtReservationNumber.Text = reservationId;
            ...
            UserInformationBO rUserInformationBO = userInformationDA.GetUserInformationByGroupReservationId(ReservationId);
            ...
            reportParam.Add(new ReportParameter("RoomReservationTermsAndConditions", hmCommonDA.GetCustomFieldValueByFieldName("GroupRoomReservationTermsAndConditions")));
            ...
            reservationBill = reservationDa.GetGroupRoomReservationBillInfoById(billID);
            ...
            rvTransaction.LocalReport.DisplayName = "Group Reservation Confirmation Letter";
