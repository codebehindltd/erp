...
namespace HotelManagement.Presentation.Website.HotelManagement.Reports
{
    public partial class frmReportRoomSalesRevenue : BasePage
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptRoomSalesRevenueMonthWise.rdlc");
            }
            else
            {
            ...
            rvTransaction.LocalReport.DisplayName = "Room Sales Revenue (Bar Chart)";
