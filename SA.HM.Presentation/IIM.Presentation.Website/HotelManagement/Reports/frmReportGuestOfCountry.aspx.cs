...
{
    public partial class frmReportGuestOfCountry : BasePage
    {
        int _offset = -360;
        int _mindiff = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptGuestOfCountry.rdlc");
            ...
            List<GuestsCountryReportViewBO> guestsCountriesBO = new List<GuestsCountryReportViewBO>();
            guestsCountriesBO = reportDA.GetCountriesofGuests(FromDate, ToDate);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], guestsCountriesBO));

            rvTransaction.LocalReport.DisplayName = "Country Wise Guest";
