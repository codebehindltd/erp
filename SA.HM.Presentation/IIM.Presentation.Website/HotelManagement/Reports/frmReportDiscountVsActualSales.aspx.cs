...
{
    public partial class frmReportDiscountVsActualSales : BasePage
    {
        int _offset = -360;
        int _mindiff = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptDiscountVsActualSales.rdlc");
            ...
            List<DiscountVsActualSaleReportViewBO> salesBO = new List<DiscountVsActualSaleReportViewBO>();
            salesBO = reportDA.GetDiscountVsActualSalesInfo(reportYear, durationName);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], salesBO));

            rvTransaction.LocalReport.DisplayName = "Discount VS Actual Room Sale";
