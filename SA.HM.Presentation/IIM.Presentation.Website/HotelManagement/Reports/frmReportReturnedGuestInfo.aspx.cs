...
{
    public partial class frmReportReturnedGuestInfo : BasePage
    {
        int _offset = -360;
        int _mindiff = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptReturnedGuestInformation.rdlc");
            ...
            List<ReturnedGuestReportViewBO> returnGuestsBO = new List<ReturnedGuestReportViewBO>();
            returnGuestsBO = reportDA.GetReturnedGuestInfo(FromDate, ToDate);

            var reportDataset = rvTransaction.LocalReport.GetDataSourceNames();
            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataset[0], returnGuestsBO));

            rvTransaction.LocalReport.DisplayName = "Returned Guest Information";
