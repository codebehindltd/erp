...
{
    public partial class frmReportPromotionalGuestInfo : BasePage
    {
        int _offset = -360;
        int _mindiff = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptPromotionalGuestInfo.rdlc");
            ...
            guestInfo = guestDa.GetRoomReservationInfoByDateRange(FromDate, ToDate);

            rvTransaction.LocalReport.DataSources.Add(new ReportDataSource(reportDataSet[0], guestInfo));
            rvTransaction.LocalReport.DisplayName = "Promotional Guest";
