...
{
    public partial class frmReportSalesAudit : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            {
                reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/RptSalesAuditYtd.rdlc");
            }
            ...
            salesAuditBO = salesAuditDA.GetSalesAuditInfo(ApprovedDate);

            List<SalesAuditReportViewBO> salesAuditPaymentBO = new List<SalesAuditReportViewBO>();
            salesAuditPaymentBO = salesAuditDA.GetSalesAuditPaymentInfo(ApprovedDate);
            ...
            rvTransaction.LocalReport.DisplayName = "Sales Summary Report";
