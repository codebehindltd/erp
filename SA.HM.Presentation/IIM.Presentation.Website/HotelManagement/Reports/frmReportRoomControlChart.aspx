<%@ Page Title="" Language="C#" MasterPageFile="~/Common/InnboardEmptyDesign.Master" AutoEventWireup="true"
    CodeBehind="frmReportRoomControlChart.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.Reports.frmReportRoomControlChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Room Control Chart</li>";
            var breadCrumbs = moduleName + formName;
            $("#ltlBreadCrumbsInformation").html(breadCrumbs);

            var paramFromDate = $.trim(CommonHelper.GetParameterByName("FromDate"));
            if (paramFromDate != "") {
                $("#ContentPlaceHolder1_txtFromDate").val(paramFromDate);
            }

            var paramToDate = $.trim(CommonHelper.GetParameterByName("ToDate"));
            if (paramToDate != "") {
                $("#ContentPlaceHolder1_txtToDate").val(paramToDate);
            }
        ...
        <div class="form-horizontal">
            <div class="form-group" style="padding-top:5px;">
                <div class="col-md-2">
                    ...
                    <asp:Label ID="lblFromDate" runat="server" class="control-label" Text="Report Date"></asp:Label>
                </div>
                <div class="col-md-2">
            ...
            <div class="form-group" style="display: none;">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlReportType" CssClass="form-control" runat="server">
                        <asp:ListItem Value="Availability">Availability Status</asp:ListItem>
                        <asp:ListItem Value="Occupancy">Occupancy Status</asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
        </div>
