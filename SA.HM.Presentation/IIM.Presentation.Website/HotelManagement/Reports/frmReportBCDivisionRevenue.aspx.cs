...
{
    public partial class frmReportBCDivisionRevenue : BasePage
    {
        int _offset = -360;
        int _mindiff = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.CheckObjectPermission(userInformationBO.UserInfoId, HMConstants.ApplicationFormName.frmReportDivisionRevenue.ToString());
                LoadYearList();
            }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/HotelManagement/Reports/Rdlc/rptBarChartRevenue.rdlc");
            ...
            rvTransaction.LocalReport.DisplayName = "Division Revenue";
