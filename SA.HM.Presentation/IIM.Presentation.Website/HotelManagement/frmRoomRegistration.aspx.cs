...
{
    public partial class frmRoomRegistration : System.Web.UI.Page
    {
        ...
        protected void ddlReservationId_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.chkIsFromReservation.Checked)
            {
                if (this.ddlReservationId.SelectedIndex != -1)
                {
                    ...
                    //     this.txtLedgerAmount.Text = paymentBO.PaymentAmout.ToString();
                }
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //decimal cmpUnitPriceHiddenField = !string.IsNullOrWhiteSpace(txtUnitPriceHiddenField.Value) ? Convert.ToDecimal(txtUnitPriceHiddenField.Value) : 0;
                //decimal cmpRoomRate = !string.IsNullOrWhiteSpace(txtRoomRate.Text) ? Convert.ToDecimal(txtRoomRate.Text) : 0;

                //if (cmpRoomRate > cmpUnitPriceHiddenField)
                //{
                //    this.isMessageBoxEnable = 1;
                //    this.lblMessage.Text = "Negotiated Rate must be less than or equal to Rack Rate";
                //    this.txtRoomRate.Focus();
                //    this.SetTab("EntryTab");
                //    return;
                //}
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            roomRegistrationBO.ReservationId = this.chkIsFromReservation.Checked ? Convert.ToInt32(this.ddlReservationId.SelectedValue) : 0;
                        }
                        ...
                        //roomRegistrationBO.ArriveDate = hmUtility.GetDateTimeFromString(this.txtCheckInDate.Text);
                        ...
                        //roomRegistrationBO.RegistrationMode = this.ddlRegistrationMode.SelectedItem.Text;
                        ...
                        //roomRegistrationBO.DiscountAmount = 

                        //if (roomRegistrationBO.DiscountType == "Fixed")
                        //{
                        //    //roomRegistrationBO.Discount = singleEntityBO.UnitPrice - RoomRateAmount;
                        //    roomRegistrationBO.DiscountAmount = roomRegistrationBO.UnitPrice - roomRegistrationBO.RoomRate;
                        //}
                        //else
                        //{
                        //    decimal percantAmount = (((roomRegistrationBO.UnitPrice - roomRegistrationBO.RoomRate) / roomRegistrationBO.UnitPrice) * 100);
                        //    //detailBO.Discount = percantAmount;
                        //    roomRegistrationBO.DiscountAmount = percantAmount;
                        //}

                        //roomRegistrationBO.DiscountAmount = !string.IsNullOrWhiteSpace(this.txtDiscountAmount.Text) ? Convert.ToDecimal(this.txtDiscountAmount.Text) : 0;
                        ...
                        //guestBillPaymentBO.PaymentAmout = string.IsNullOrWhiteSpace(this.txtLedgerAmount.Text) ? 0 : Convert.ToDecimal(this.txtLedgerAmount.Text.Trim());
                        ...
                        roomRegistrationBO.BusinessPromotionId = Convert.ToInt32(this.ddlBusinessPromotionId.SelectedValue);
                        ...
                        //this.txtDepartureMin.Text = this.txtDepartureMin.Text == "NaN" ? "" : this.txtDepartureMin.Text;
                        //this.txtDepartureHour.Text = this.txtDepartureHour.Text == "NaN" ? "" : this.txtDepartureHour.Text;
                        //int DMin = !string.IsNullOrWhiteSpace(this.txtDepartureMin.Text) ? Convert.ToInt32(this.txtDepartureMin.Text) : 0;
                        //int departureHour = !string.IsNullOrWhiteSpace(this.txtDepartureHour.Text) ? Convert.ToInt32(this.txtDepartureHour.Text) : 0;
                        //int DHour = this.ddlDepartureAmPm.SelectedIndex == 0 ? (departureHour % 12) : ((departureHour % 12) + 12);
                        //roomRegistrationBO.DepartureTime = currentDate.AddHours(DHour).AddMinutes(DMin);
        ...
        private void LoadRoomNumber(int roomTypeId)
        {
            ...
            else
            {
                ...
                if (!string.IsNullOrWhiteSpace(this.txtCheckInDate.Text))
                {
                    ...
                    //StartDate = hmUtility.GetDateTimeFromString(this.txtCheckInDate.Text);
                }
        ...
        public void DeleteTempGuestRegistration()
        {
            ...
            int registratinId = Convert.ToInt32(Session["_RoomRegistrationId"]);
            Boolean status = regDA.DeleteTempGuestRegistration(registratinId);
            if (status)
                hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Delete.ToString(), EntityTypeEnum.EntityType.RoomRegistration.ToString(), registratinId, ProjectModuleEnum.ProjectModule.FrontOffice.ToString(), hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.RoomRegistration));
        }
        ...
        private void LoadCommonSetupForRackRateServiceChargeVatInformation()
        {
            ...
            commonSetupBO = commonSetupDA.GetCommonConfigurationInfo("InclusiveHotelManagementBill", "Inclusive HotelManagement Bill Setup");
            hfInclusiveHotelManagementBill.Value = commonSetupBO.SetupValue;

            commonSetupBO = new HMCommonSetupBO();
            commonSetupBO = commonSetupDA.GetCommonConfigurationInfo("GuestHouseVat", "Vat Amount Setup");
            hfGuestHouseVat.Value = commonSetupBO.SetupValue;

            commonSetupBO = new HMCommonSetupBO();
            commonSetupBO = commonSetupDA.GetCommonConfigurationInfo("GuestHouseServiceCharge", "Service Charge Setup");
        ...
        public static string LoadGrid(int actionId)
        {
            ...
            string strTable = "";
            strTable += "<table cellspacing='0' cellpadding='4' id='TableWiseItemInformation_Room'><tr style='color: White; background-color: #44545E; font-weight: bold;'>";
