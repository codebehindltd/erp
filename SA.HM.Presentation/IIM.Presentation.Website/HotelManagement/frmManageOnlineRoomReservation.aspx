<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Common/Innboard.Master"
    AutoEventWireup="true" CodeBehind="frmManageOnlineRoomReservation.aspx.cs" Inherits="HotelManagement.Presentation.Website.HotelManagement.frmManageOnlineRoomReservation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function LoadDetailGridInformation() {
            ...
            var txtGuestNationality = $("#<%=txtGuestNationality.ClientID %>").val();
            var txtGuestCountrySearch = $.trim($("#txtGuestCountrySearch").val());
            var guestClassificationId = $("#<%=ddlClassificationId.ClientID %>").val();
            ...
            */
            ...
            if (txtGuestName == "" || txtNumberOfPersonAdult == "") {
                ...
                var hfReservationIdTemp = $("#<%=hfReservationIdTemp.ClientID %>").val();
                var reservationId = parseInt(hfReservationIdTemp);
                PageMethods.SaveGuestInformationAsDetail(reservationId, prevGuestId, isEdit, 0, txtTitle, txtFirstName, txtLastName, txtGuestName, txtGuestEmail, hiddenGuestId, txtGuestDrivinlgLicense, txtGuestDOB, txtGuestAddress1, txtGuestAddress2, ddlProfessionId, txtGuestCity, ddlGuestCountry, txtGuestNationality, txtGuestPhone, ddlGuestSex, txtGuestZipCode, txtNationalId, txtPassportNumber, txtPExpireDate, txtPIssueDate, txtPIssuePlace, txtVExpireDate, txtVisaNumber, txtVIssueDate, roomId, SelectdPreferenceId, guestClassificationId, OnLoadDetailGridInformationSucceeded, OnLoadDetailGridInformationFailed);
                return false;
            }
        }
        ...
        function ValidateGuestNumber() {
            ...
            reservationTempId = "0", reservationDuration = "", onlineReservationId = 0, displayRoomNumberNType = "", marketSegmentId = "", guestSourceId = "";
            ...
            onlineReservationId = $("#ContentPlaceHolder1_hfReservationId").val();
            ...
            //                toastr.warning("Please Provide Valid Telephone Number.");
            //                return false;
            //            }
            ...
            if (airportPickUp == "YES" || airportPickUp == "TBA") {
                ...
                //isAirportPickupDropExist = false;
            ...
            var RoomReservation = {
                ...
                OnlineReservationId: onlineReservationId,
                DateIn: dateIn,
                DateOut: dateOut,
                DateInStr: dateIn,
            ...
            PageMethods.SaveReservation(RoomReservation, GuestDetails, RoomReservationDetail, AireportPickupDrop, AddedAirportPickupDrop, DeletedAirportPickupDrop, ComplementaryItem,
        ...
        function ClearForm() {
            ...
            //setTimeout(ClearFormFromServer(), 10000);
        }
        ...
        function ChangeServiceCost(serviceId) {
            ...
            //            var tr = $("#trsr" + serviceId);
            //            var inputServiceCharge = $("#txt" + serviceId).val();
            //            var roomRate = parseFloat($.trim($("#ContentPlaceHolder1_txtRoomRate").val()));
        ...
        function OnPerformRoomAvailableCheckingSucceeded(result) {
            ...
            if (parseFloat(result) < parseFloat(txtRoomIdVal)) {
                //toastr.warning('This type of room is not available.');
                        ...
                        <asp:Panel ID="pnlReservationEditTimePanelwillHide" runat="server">
                            ...
                            <div class="form-group">
                                <%--<label for="DateOfBirth" class="control-label col-md-2">
                                    Date Of Birth</label>
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtDOB" runat="server" CssClass="form-control" TabIndex="32"></asp:TextBox>
                                </div>--%>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txtPIssuePlace" runat="server" CssClass="form-control" TabIndex="48"></asp:TextBox>
                            </div>--%>
