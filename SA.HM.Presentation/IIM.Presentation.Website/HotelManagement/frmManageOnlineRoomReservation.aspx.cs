...
{
    public partial class frmManageOnlineRoomReservation : System.Web.UI.Page
    {
        ...
        private void CheckObjectPermission()
        {
            ...
            objectPermissionBO = hmUtility.ObjectPermission(userInformationBO.UserInfoId, HMConstants.ApplicationFormName.frmRoomReservationNew.ToString());
        ...
        private void FillForm(int reservationId)
        {
            ...
            LoadIsConversionRateEditable();
            roomReservationBO = roomReservationDA.GetOnlineRoomReservationInfoById(reservationId);
            ...
            List<GuestInformationBO> guestInformationList = new List<GuestInformationBO>();
            GuestInformationDA guestInformationDA = new GuestInformationDA();
            guestInformationList = guestInformationDA.GetGuestOnlineInformationDetailByResId(Convert.ToInt32(reservationId), true);
            ...
            reservationDetailListBOForGrid = reservationDetailDA.GetOnlineReservationDetailByRegiIdForGrid(reservationId, 0);
            Session["ReservationDetailListForGrid"] = reservationDetailListBOForGrid;
            ...
            List<ReservationDetailBO> reservationDetailListBO = new List<ReservationDetailBO>();
            reservationDetailListBO = reservationDetailDA.GetOnlineReservationDetailByRegiIdForGrid(reservationId, 0);
            Session["ReservationDetailList"] = reservationDetailListBO;
        ...
        private static string GetUserDetailHtml(List<GuestInformationBO> registrationDetailListBO)
        {
            ...
            //ltlGuestDetailGrid.InnerText = strTable;
        ...
        [WebMethod(EnableSession = true)]
        public static ReturnInfo SaveReservation(RoomReservationBO RoomReservation, GuestInformationBO GuestDetailsInfo, List<ReservationDetailBO> RoomReservationDetail, List<HotelReservationAireportPickupDropBO> AireportPickupDrop, List<HotelReservationAireportPickupDropBO> AddedAirportPickupDrop, List<HotelReservationAireportPickupDropBO> DeletedAirportPickupDrop, List<ReservationComplementaryItemBO> ComplementaryItem, List<RegistrationServiceInfoBO> PaidServiceDetails, bool paidServiceDeleted, string displayRoomNumberNType)
        {
            ...
            try
            {
                ...
                if (RoomReservation.ReservationId == 0)
                {
                    ...
                    rtnInfo.IsSuccess = roomReservationDA.SaveRoomReservationInfoNew(RoomReservation, RoomReservationDetail, null, AireportPickupDrop, AddedAirportPickupDrop, ComplementaryItem,
                    ...
                    if (rtnInfo.IsSuccess)
                    {
                        ...
                        if(RoomReservationDetail.Count > 0)
                        {
                            foreach (var item in RoomReservationDetail)
                            {
                                hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Edit.ToString(), EntityTypeEnum.EntityType.GuestReservationMapping.ToString(), tmpReservationId, ProjectModuleEnum.ProjectModule.FrontOffice.ToString(), hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.GuestReservationMapping));
                            }
                        }
                ...
                else
                {
                    ...
                    rtnInfo.IsSuccess = roomReservationDA.UpdateRoomReservationInfoNew(RoomReservation, reservationDetailAddedList, reservationDetailEditedList,
                                                                reservationDetailDeletedList, null, null,AireportPickupDrop, AddedAirportPickupDrop, DeletedAirportPickupDrop, newlyAddedComplementaryItem,
                                                                deletedComplementaryItem, PaidServiceDetails, paidServiceDeleted, string.Empty, out currentReservationNumber);
        ...
        public static string SaveGuestInformationAsDetail(string reservationId, int prevGuestId, string isEdit, int IsEditFromAddMore, string title, string firstName, string lastName, string txtGuestName, string txtGuestEmail, string hiddenGuestId, string txtGuestDrivinlgLicense, string txtGuestDOB, string txtGuestAddress1, string txtGuestAddress2, string ddlProfessionId, string txtGuestCity, string ddlGuestCountry, string txtGuestNationality, string txtGuestPhone, string ddlGuestSex, string txtGuestZipCode, string txtNationalId, string txtPassportNumber, string txtPExpireDate, string txtPIssueDate, string txtPIssuePlace, string txtVExpireDate, string txtVisaNumber, string txtVIssueDate, int roomId, string selectedPreferenceId, int classificationId)
        {
            ...
            bool status = resDA.SaveTemporaryGuestNew(detailBO, reservationId, preferenList);
            if(status)
            {
            ...
            //    {
            //        detailBO.GuestId = prevGuestId;
            //        Boolean status = guestDA.UpdateGuestInformationNew(detailBO, reservationId, string.Empty, preferenList);
            //    }
            //}
            //else
            //{
        ...
        private static void SaveGuestDetailsWithFInalSave(GuestInformationBO guestInfo)
        {
            ...
            if (guestInfo.GuestId == 0)
            {
                ...
                {
                    status = resDA.SaveTemporaryGuestNew(guestInfo, guestInfo.tempOwnerId.ToString(), preferenList);
                    if (status)
                    {
                        hmUtility.CreateActivityLogEntity(ActivityTypeEnum.ActivityType.Add.ToString(), EntityTypeEnum.EntityType.GuestInformation.ToString(), guestInfo.GuestId,
                     ProjectModuleEnum.ProjectModule.FrontOffice.ToString(), hmUtility.GetEntityTypeEnumDescription(EntityTypeEnum.EntityType.GuestInformation));
                        if (preferenList.Count > 0)
                        {
                            foreach (var item in preferenList)
        ...
        public static GuestInformationBO PerformEditActionForGuestDetailByWM(int GuestId)
        {
            GuestInformationBO guestBO = new GuestInformationBO();
            GuestInformationDA guestDA = new GuestInformationDA();
            guestBO = guestDA.GetOnlineGuestInformationByGuestId(GuestId);
        ...
        public static string GetTempRegistration()
        {
            List<GuestInformationBO> guestInformationList = new List<GuestInformationBO>();
            GuestInformationDA guestInformationDA = new GuestInformationDA();
            guestInformationList = guestInformationDA.GetGuestOnlineInformationDetailByResId(ReservationId, true);
            return GetUserDetailHtml(guestInformationList);
        }
        [WebMethod]
        ...
        public static string GetHTMLGuestReferenceGridView(List<GuestPreferenceBO> List)
        {
            ...
            //strTable += "<tr> <td colspan='2'>";
            //strTable += "<div style=\"height: 375px; overflow-y: scroll; text-align: left;\">";
            //strTable += "<table class='table table-bordered table-condensed table-responsive' width='100%' id='GuestReference' >";
            int counter = 0;
