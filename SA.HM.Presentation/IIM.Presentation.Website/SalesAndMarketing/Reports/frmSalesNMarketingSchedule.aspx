<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmSalesNMarketingSchedule.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesAndMarketing.Reports.frmSalesNMarketingSchedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Schedule Information</li>";
            ...
            $("#ContentPlaceHolder1_ddlSalesPerson").select2({
                tags: "true",
                placeholder: "--- All ---",
                allowClear: true,
                width: "99.75%"
        ...
        <div class="row" style="padding-left: 30px">
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            <asp:Label ID="lblSalesPerson" runat="server" class="control-label" Text="Sales Person"></asp:Label>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <asp:Label ID="lblpurpose" runat="server" class="control-label" Text="Purpose"></asp:Label>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <asp:Button ID="btnGenerate" runat="server" Text="Generate" CssClass="btn btn-primary btn-sm"
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none;">
        <div class="panel-heading">
            Report:: Sales & Marketing Schedule</div>
        <div class="panel-body">
            <asp:Panel ID="pnlReporContainer" runat="server" ScrollBars="Both" Height="700px">
                <rsweb:ReportViewer ShowFindControls="false" ShowWaitControlCancelLink="false" ID="rvSalesSchedule"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if (CommonHelper.BrowserType().mozilla || CommonHelper.BrowserType().chrome) {
                ...
                var barControlId = CommonHelper.GetReportViewerControlId($("#<%=rvSalesSchedule.ClientID %>"));
