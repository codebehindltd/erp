<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmCompanyPaymentCollection.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesAndMarketing.Reports.frmCompanyPaymentCollection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#ContentPlaceHolder1_ddlCollectionType").val() == "Adjustment") {
                $("#AdjustmentByHeadDiv").show();
            }
            else if ($("#ContentPlaceHolder1_ddlReportType").val() == "0") {
                $("#AdjustmentByHeadDiv").hide();
            }
            ...
            $("#ContentPlaceHolder1_ddlCollectionType").change(function () {
                if ($("#ContentPlaceHolder1_ddlCollectionType").val() == "Adjustment") {
                    $("#AdjustmentByHeadDiv").show();
                }
                else if ($("#ContentPlaceHolder1_ddlReportType").val() == "0") {
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-md-2">
                        <%--<asp:Label ID="Label2" runat="server" class="control-label required-field" Text="Search Type"></asp:Label>--%>
                    ...
                    <div class="col-md-2" style="display:none;">
                        <asp:DropDownList ID="ddlReportFormat" runat="server" CssClass="form-control">
                            <asp:ListItem Text="Company Wise" Value="Company"></asp:ListItem>
                            <asp:ListItem Text="Date Wise" Value="Date"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="Label4" runat="server" class="control-label" Text="Collection Type"></asp:Label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group" id="AdjustmentByHeadDiv" style="display:none;"> 
                    <div class="col-md-2">
                        <asp:Label ID="Label7" runat="server" class="control-label" Text="Adjustment Head"></asp:Label>
                    </div>
                    <div class="col-md-10">
                        <asp:DropDownList ID="ddlAdjustmentNodeHead" runat="server" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">                    
                    <div class="col-md-2">
                        <asp:Label ID="Label5" runat="server" class="control-label" Text="Received By"></asp:Label>
                    </div>
                    <div class="col-md-10">
    ...
    <div id="ReportPanel" class="panel panel-default">
        <div class="panel-heading">
            Report:: Company Payment Collection
        </div>
        <div class="panel-body">
