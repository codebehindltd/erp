<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="frmSalesOrderSearch.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesAndMarketing.frmSalesOrderSearch" %>
...
function PopulateProjects() {
    $("#<%=ddlGLProject.ClientID%>").attr("disabled", "disabled");
        ...
        function BillReSettlementForBilling(billId, CostCenterId) {
            ...
            window.location = "/SalesAndMarketing/frmSalesOrder.aspx?cid=" + CostCenterId + "&salesOrderID=" + billId;
        }
