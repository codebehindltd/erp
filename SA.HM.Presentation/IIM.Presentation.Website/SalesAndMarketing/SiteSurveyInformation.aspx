<%@ Page Title="" Language="C#" MasterPageFile="~/Common/InnboardEmptyDesign.Master" AutoEventWireup="true" CodeBehind="SiteSurveyInformation.aspx.cs" Inherits="HotelManagement.Presentation.Website.SalesAndMarketing.SiteSurveyInformation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        var companyId = 0;
        var contactId = 0;
        var isFromQuotation = 0;
        $(document).ready(function () {

            dealId = $.trim(CommonHelper.GetParameterByName("dId")) == "" ? 0 : $.trim(CommonHelper.GetParameterByName("dId"));
            companyId = $.trim(CommonHelper.GetParameterByName("cId")) == "" ? 0 : $.trim(CommonHelper.GetParameterByName("cId"));
            contactId = $.trim(CommonHelper.GetParameterByName("conId")) == "" ? 0 : $.trim(CommonHelper.GetParameterByName("conId"));
            isFromQuotation = $.trim(CommonHelper.GetParameterByName("isFromQuotation")) == "" ? 0 : $.trim(CommonHelper.GetParameterByName("isFromQuotation"));
            GridPaging(1, 1);
        });
        ...
        function LoadGrid(pageNumber, IsCurrentOrPreviousPage) {
            ...
            $.ajax({
                ...
                data: "{'dealId':'" + dealId + "','companyId':'" + companyId + "','contactId':'" + contactId + "', 'gridRecordsCount':'" + gridRecordsCount + "', 'pageNumber':'" + pageNumber + "', 'isCurrentOrPreviousPage':'" + IsCurrentOrPreviousPage + "'}",
                dataType: "json",
        ...
        function LoadTable(data) {
            ...
            $.each(data.d.GridData, function (count, gridObject) {
                ...
                if (gridObject.Status == "Pending") {
                    tr += " <a onclick=\"javascript:return FillFormEdit(" + gridObject.Id + ");\" title='Edit' href='javascript:void();'><img src='../Images/edit.png' alt='Edit'></a>";
                }
                ...
                if (isFromQuotation == "1" && gridObject.Status == "Done")
                    tr += "&nbsp;&nbsp;<a onclick=\"javascript:return CreateQuotation(" + gridObject.DealId + "," + gridObject.CompanyId + "," + gridObject.ContactId + "," + gridObject.Id + ");\" title='Create Quotation' href='javascript:void();'><img src='../Images/salesQuotation.png' alt='Create Quotation'></a>";
        ...
        function FillFormEdit(id) {
            ...
            var url = "./SiteSurveyNote.aspx?editId=" + id;
        ...
        function CreateQuotation(dealId, companyId, contactId, siteServeyId) {
            var iframeid = 'frmPrint';
            var url = "./frmSMQuotation.aspx?did=" + dealId + "&cid=" + companyId + "&conid=" + contactId + "&sid=" + siteServeyId;
            parent.parent.parent.document.getElementById(iframeid).src = url;
