<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmPayFirstRestaurantBill.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.frmPayFirstRestaurantBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
            ...
            $("#txtItemName").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: '../POS/frmPayFirstRestaurantBill.aspx/ItemNCategoryAutoSearch',
        ...
        function AddNewItem(itemId) {                 
            ...
            table += "<th align='left' scope='col' style='width: 10%;'>Unit</th>";
            table += "<th align='left' scope='col' style='width: 15%;'>U. Rate</th>";
            ...
            table += "<td align='left' style='width: 20%;'>" + total + "</td>";
        ...
        function UpdateItemDetails(updateType) {
            ...
            if (updateType == "QuantityChange") {
                ...
                toastr.success("Unit Price Updated Successfully");
            }
        ...
        function AddNewPayment(itemId) {
            ...
            if (paymentMode == 4) {
                if (companyName == "") {
                    toastr.warning("Please provide company Information.");
                    return false;
                }
            }
        ...
        function TotalSalesAmountVatServiceChargeCalculation() {
            ...
            var totalAmount = 0;
            $('#ItemInformation tbody tr').each(function () {
                totalAmount += parseInt($.trim($(this).find("td:eq(5)").text()), 10)
            });
        ...
        function Settlement(savetype) {
            ...
            $("#ItemInformation tbody tr").each(function () {
                ...
                var itemUnit = parseInt($.trim($(this).find("td:eq(3)").text(), 10));
            ...
            if (savetype == "Settlement") {
                ...
                PageMethods.SaveSettlement(savetype, kotId, billId, ItemMaster, ItemDetails, RestaurantBill, GuestPayment, OnSettlementSuccess, OnSettlementFail);
            }
            else if (savetype == "Challan") {
                PageMethods.SavePreview(kotId, billId, ItemMaster, ItemDetails, RestaurantBill, OnChallanSaveSuccess, OnChallanSaveFail);
            }
            else {
                if (hfCreditSale == 1) {
                    if (companyName == "") {
                ...
                PageMethods.SavePreview(kotId, billId, ItemMaster, ItemDetails, RestaurantBill, OnSaveSuccess, OnSaveFail);
            }
            return false;
        }
...
//            }
            ...
            if (result[1] != "" || result[1] != 0) {
                if (result[1] != "" || result[1] != 0) {
                    var url = "/Restaurant/Reports/frmReportRestaurantBillInfo.aspx?billID=" + result[1];
        ...
        function CalculateTotalAmount() {
            ...
            if (hfCreditSale == 1) {
                ...
                $("#ContentPlaceHolder1_txtChangeAmount").val((parseFloat(grandTotal) - parseFloat(totalAmount)));
            }
        }
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="padding-left: 5px;">
            <div id="ItemDetailsDiv" class="panel panel-default" style="padding-bottom: 5px;">
                ...
                <div class="panel-body">
                    <div class="form-horizontal" id="CostCenterDivInformation" runat="server">
                        ...
                        <div class="form-group">
                            <div class="col-md-3">
                                <asp:Label ID="lblItemUnit" runat="server" class="control-label" Text="Unit Price"></asp:Label>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlPayMode" runat="server" CssClass="form-control" TabIndex="5">
                                        ...
                                        <%--<asp:ListItem Value="5">Member</asp:ListItem>--%>
                        ...
                        <div class="row" style="padding-left: 15px; padding-top: 10px;">
                            ...
                            <div id="CmpButton" class="col-md-6" style="padding-top: 10px;">
                                ...
                                <input type="button" id="btnEnvelope" value="Envelope Print" class="TransactionalButton btn btn-primary btn-sm"
            ...
            <div class="row" style="padding-left: 5px;">
                <div class="col-md-2">
                    <asp:Button ID="btnPreview" runat="server" TabIndex="14" Text="Bill View" CssClass="TransactionalButton btn btn-primary btn-sm samewidthbutton"
                        OnClientClick="javascript: return Settlement('Preview');" />
                </div>
                <div class="col-md-2">
                    <asp:Button ID="btnChallan" runat="server" TabIndex="14" Text="Challan" CssClass="TransactionalButton btn btn-primary btn-sm samewidthbutton"
                        OnClientClick="javascript: return Settlement('Challan');" />
                </div>
                <div class="col-md-2">
                    <asp:Button ID="btnSave" runat="server" TabIndex="13" Text="Settlement" CssClass="TransactionalButton btn btn-primary btn-sm samewidthbutton"
