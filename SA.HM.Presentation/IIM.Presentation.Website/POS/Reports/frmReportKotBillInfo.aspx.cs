...
{
    public partial class frmReportKotBillInfo : System.Web.UI.Page
    {
        ...
        protected void btn2PrintReportFromClient_Click(object sender, EventArgs e)
        {
           ...
           "</DeviceInfo>";
            ...
            frmPrint2.Attributes["src"] = "../../PrintDocument/" + fileNamePrint;
        ...
        private void ReportProcessingForTemplateOne()
        {
            ...
            {
                tableNumber = Request.QueryString["tno"].ToString();
            }

            if (Request.QueryString["room"] != null)
            {
                tableNumber = Request.QueryString["room"].ToString();
            }
                ...
                if (files.Count > 0)
                {
                    foreach (PrinterInfoBO pinfo in files)
                    {
                        ...
                        if (pinfo.StockType == "StockItem")
                        {
                            ...
                            entityBOList = entityDA.GetKotOrderSubmitInfo(kotId, strCostCenterId, "StockItem", IsReprint);
                            ...
                            if (entityBOList.Count > 0)
                            {
                                ...
                                //parms[4] = new ReportParameter("KotNo", kotId.ToString());
