<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportDateWiseSalesSummary.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.Reports.frmReportDateWiseSalesSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Date Wise Sales Summary</li>";
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">
        <div class="panel-heading">
            Report:: Date Wise Sales Summary</div>
        <div class="panel-body">
