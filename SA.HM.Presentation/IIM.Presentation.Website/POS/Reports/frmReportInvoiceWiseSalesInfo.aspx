<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmReportInvoiceWiseSalesInfo.aspx.cs"
    Inherits="HotelManagement.Presentation.Website.POS.Reports.frmReportInvoiceWiseSalesInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var formName = "<span class='divider'>/</span><li class='active'>Invoice Wise Sales Info</li>";
            ...
            $("#ContentPlaceHolder1_ddlCashierName").select2({
                tags: false,
                placeholder: "--- All ---",
                allowClear: true,
                width: "99.75%"
    ...
    <div id="SearchPanel" class="panel panel-default">        
        ...
        <div class="panel-body">
            <div class="form-horizontal">                
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            <asp:Label ID="Label1" runat="server" class="control-label " Text="Cashier Name"></asp:Label>                            
                        </div>
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlCashierName" CssClass="form-control" runat="server">
                            </asp:DropDownList>
                        </div>
                    </div>                   
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">        
            <div class="panel-heading">Report:: Invoice Wise Sales Information</div>
        <div class="panel-body">
