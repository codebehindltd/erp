<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportKotDetailsInfo.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.Reports.frmReportKotDetailsInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ContentPlaceHolder1_ddlSettledBy").select2({
                tags: "true",
                //placeholder: "--- All ---",
                allowClear: true,
                width: "99.75%"
    ...
    <div id="SearchPanel" class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-2">
                        <asp:Label ID="Label1" runat="server" class="control-label" Text="KOT Number"></asp:Label>
                    </div>
                    <div class="col-md-4 ">
                        <asp:TextBox ID="txtKotNumber" runat="server" CssClass="form-control quantity"></asp:TextBox>
                        <%--<asp:DropDownList ID="ddlKotNumber" runat="server" CssClass="form-control" TabIndex="3">
                        </asp:DropDownList>--%>
                    </div>
                    <div class="col-md-2">
                        <asp:Label ID="Label2" runat="server" class="control-label" Text="Bill Number"></asp:Label>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtBillNumber" runat="server" CssClass="form-control"></asp:TextBox>
                       <%-- <asp:DropDownList ID="ddlBillNumber" runat="server" CssClass="form-control" TabIndex="3">
                        </asp:DropDownList>--%>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="Label3" runat="server" class="control-label " Text="Settled By"></asp:Label>
                    </div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlSettledBy" runat="server" CssClass="form-control" TabIndex="3">
                        </asp:DropDownList>
                    </div>
                </div>
    ...
    <div id="ReportPanel" class="panel panel-default" style="display: none">        
            <div class="panel-heading">Report:: Restaurant KOT Details Information</div>
        <div class="panel-body">
