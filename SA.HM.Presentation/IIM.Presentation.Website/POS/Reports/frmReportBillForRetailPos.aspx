<%@ Page Title="" Language="C#" MasterPageFile="~/Common/IRReportViewer.Master" AutoEventWireup="true"
    CodeBehind="frmReportBillForRetailPos.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.Reports.frmReportBillForRetailPos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblReportMessage" Enabled="false" runat="server" Text="" CssClass="form-control"></asp:Label>
