...
{
    public partial class frmChooseTableForBill : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(Request.QueryString["CostCenterId"]))
            {
                ...
                Response.Redirect("/POS/FrmChooseTableForBill.aspx");
            }
            ...
            {                
                ...
                if (costCentreTabBO != null)
                {
                    ...
                    {
                        if (costCentreTabBO.DefaultView == "Table")
                        {
                            LoadTableAllocation(Convert.ToInt32(hfCostCenterId.Value));
...
//                    {
//                        subContent += @"<a href='/Restaurant/frmRestaurantBill.aspx?RoomNumber=" + roomNumberListBO[iRoomNumber].RoomNumber;
//                        subContent += "'>";
...
//            }
            ...
            groupNamePart = " Room Information";
