<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmFrontOfficeUser.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.frmFrontOfficeUser" %>
                ...
                <div class="panel-body">
                    <asp:GridView ID="gvBearerInformation" Width="100%" runat="server" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="EmployeeName" HeaderText="User Name" ItemStyle-Width="25%">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Action" ShowHeader="False" ItemStyle-Width="15%">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgUpdate" runat="server" CausesValidation="False" CommandName="CmdEdit"
                                        CommandArgument='<%# bind("EmpId") %>' ImageUrl="~/Images/edit.png" Text="" AlternateText="Edit"
                                        ToolTip="Edit" />
                                    &nbsp;<asp:ImageButton ID="ImgDelete" runat="server" CausesValidation="False" CommandName="CmdDelete"
                                        CommandArgument='<%# bind("EmpId") %>' ImageUrl="~/Images/delete.png" Text=""
