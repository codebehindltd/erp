    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: '../POS/Billing.aspx/GetAllDiscount',
            ...
            $("#ItemName").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: '../POS/Billing.aspx/GetItemByCodeCategoryNameWiseItemDetailsForAutoSearch',
            ...
            $("#CustomerCode").keypress(function (event) {
                ...
                if (keycode == '13') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: '../POS/Billing.aspx/GetPointsByCustomerCode',
        ...
        function OnSuccessLoading(result) {
            ...
            for (var i = 0; i < result.RestaurantKotBillPayment.length; i++) {
                ...
                {
                    $("#txtCash").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                }
                else if (result.RestaurantKotBillPayment[i].PaymentMode == "Company")
                {
                    $("#txtCompanyPayment").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                ...
                else if (result.RestaurantKotBillPayment[i].PaymentMode == "Card" && result.RestaurantKotBillPayment[i].CardType == "a") {
                    $("#txtAmexCard").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                }
                else if (result.RestaurantKotBillPayment[i].PaymentMode == "Card" && result.RestaurantKotBillPayment[i].CardType == "m") {
                    $("#txtMasterCard").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                }
                else if (result.RestaurantKotBillPayment[i].PaymentMode == "Card" && result.RestaurantKotBillPayment[i].CardType == "v") {
                    $("#txtVisaCard").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                }
                else if (result.RestaurantKotBillPayment[i].PaymentMode == "Card" && result.RestaurantKotBillPayment[i].CardType == "d") {
                    $("#txtDiscoverCard").val(result.RestaurantKotBillPayment[i].PaymentAmount);
                }
        ...
        function AddRemarks() {
            ...
            $.ajax({
                type: "POST",
                url: "Billing.aspx/FullBillRefundSettlement",
                data: JSON.stringify({
                    memberId: MemberId,
            ...
            $("#txtSearchBank").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: 'Billing.aspx/GetBankInfoForAutoComplete',
            ...
            $("#txtSearchContact").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: 'Billing.aspx/GetContactInfoForAutoComplete',
        ...
        function AddItem() {
            debugger;
            var alreadyAddedItem, itemId, itemName;
        ...
        function CheckQuantity(control) {
            ...
            //var remarks = $.trim($(tr).find("td:eq(7)").find("input").val());
        ...
        function BillSettlement() {
            ...
            var kotDetailId = "0", kotId = "0", itemId, itemCode, itemName, stockBy, quantity, unitPrice, remarks,
            ...
            $.ajax({
                type: "POST",
                url: "BillingResettlement.aspx/BillSettlement",
                data: JSON.stringify({
        ...
        function GetHoldUpPosInfo() {
            ...
            $.ajax({
                type: "POST",
                url: "Billing.aspx/GetHoldUpPosInfo",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
        ...
        function ResumeHoldUpBill(kotId) {
            ...
            $.ajax({
                type: "POST",
                url: "Billing.aspx/GetOrderedItemByKotId",
                data: JSON.stringify({
                    kotId: kotId
                }),
                contentType: "application/json; charset=utf-8",
                ...
                <div class="col-md-12" style="height: 410px;">
                    <div style="height: 400px; overflow-y: scroll;">
                        <table id="AddedItem" class="table table-bordered table-condensed table-hover table-responsive">
                            <thead>
                                <tr>
                                    <th id="codeCol" style="width: 12%;">Code
                                    </th>
                                    <th style="width: 20%;">Item Name
                                    </th>
                                    <th id="stockCol" style="width: 10%;">Stock</th>
                                    <th id="stockByCol" style="width: 10%;">Stock By
                                    </th>
                                    ...
                                    <th id="remarksCol" style="width: 10%;">Remarks
                                    </th>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="PosControlRight">
                        ...
                        <div id="PaymentArea">
                            <div class="form-group no-gutter" id="cashDiv">
                                <div class="col-md-5">
                                    <label for="Cash">
                                        Cash</label>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 pull-right">
                                <div class="pull-right">
                                    ...
                                    <input type="button" id="btnSettlement" value="Settlement" style="width:100px;" class="btn btn-primary" onclick="BillSettlement()" />
                                </div>
                            </div>
                        </div>
                    </div>
