<%@ Page Title="" Language="C#" MasterPageFile="~/POS/RestaurantMM.Master"
    AutoEventWireup="true" CodeBehind="frmBillReSettlement.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.frmBillReSettlement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //    CommonHelper.TouchScreenNumberKeyboardWithoutDot("numkbnotdecimal", "KeyBoardContainerQuantityChange");
            //    var keyboard = $('.numkbnotdecimal').getkeyboard();
            //    keyboard.reveal();

            //    $("#ContentPlaceHolder1_txtTouchKeypadResult_keyboard").css("top", "0px");

            //    $("#QuantityEditDialog").dialog({
            //        width: 440,
            //        height: 400,
            //        autoOpen: true,
            //        modal: true,
            ...
            $("#btnLeftBillSplitPrintPreview").click(function () {
                ...
                var url = "/POS/Reports/frmReportTPSplitBillInfo.aspx?billId=" + billId + "~" + selectedItem;
            ...
            $("#ContentPlaceHolder1_txtWaiter").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $("#ContentPlaceHolder1_hfBillOrderTakingWaiterId").val(ui.item.UserInfoId);
                }
            });
            ...
            $("#btnGuestSelectOK").click(function () {
                ...
                $("#RoomWiseGuestList tbody tr").each(function () {
                    if ($(this).find("td:eq(0)").find("input").is(":checked")) {
                        ...
                        guestList = guestList != "" ? guestList + "," + guestName : guestName + ", " + $("#lblGuestRoom").text();
                    }
                });
            ...
            //$("#ContentPlaceHolder1_txtTPDiscountAmount").on("blur", function () {
            //    $("#ContentPlaceHolder1_txtCash").focus();
            //});          
        });
        ...
        function ChangeItemName() {
            ...
            PageMethods.UpdateIndividualItemDetailInformation(userIdAuthorised, userIdAuthorisedPassword, isItemCanEditDelete, 'ItemNameChange', hfCostCenterIdVal, kotDetailId, 0, updatedContent, OnUpdateItemNameSucceeded, OnUpdateObjectFailed);
        ...
        function PerformAction(selectedItemId) {
            ...
            var isItemCanEditDelete = $("#ContentPlaceHolder1_hfIsItemCanEditDelete").val();
            PageMethods.SaveIndividualItemDetailInformation(isItemCanEditDelete, hfCostCenterIdVal, kotId, selectedItemId, selectedItemQty, OnSaveObjectSucceeded, OnSaveObjectFailed);
            return false;
        }
        ...
        function LoadGridInformation() {
            ...
            if (costCenterId > 0 && tableId > 0 && kotId > 0) {
        ...
        function PerformDeleteAction(kotDetailsId, actionId, itemId, isAlreadySubmitted) {
            ...
            PageMethods.UpdateIndividualItemDetailInformation(userIdAuthorised, userIdAuthorisedPassword, isItemCanEditDelete, 'DeleteQuantity', hfCostCenterIdVal, kotDetailsId,
        ...
        function AddNewItem(kotDetailId, kotId, itemId, isAlreadySubmitted, isItemEditable) {
            ...
            if (AddedClassificationList.length > 0) {
                ...
                $("#TableClassificationWiseDiscount tbody tr").each(function () {
                    ...
                    if (id != null) {
                        ...
                        $(this).find("td:eq(2)").find("input").val(id.DiscountAmount);
                    }
                });
            }
            else {
        ...
        function PerformUpdateActionTouchKeypad() {
            ...
            PageMethods.UpdateIndividualItemDetailInformation(userIdAuthorised, userIdAuthorisedPassword, isItemCanEditDelete, updateType, hfCostCenterIdVal, selectedId, itemQuantity, updatedContent, OnUpdateTouchKeypadObjectSucceeded, OnUpdateTouchKeypadObjectFailed);
            $("#ContentPlaceHolder1_hfIsAccessVarified").val("0");
        ...
        function OrderPreview() {
            ...
            var sourceType = CommonHelper.GetParameterByName("st");
            ...
            var iframeid = 'printDoc';
            var url = "/POS/Reports/frmTReportKotBillInfo.aspx?kotId=" + kotId + "&kotIdLst=" + kotIdLst + "&tno=" + sourceNo + "&kbm=" + "kotb" + "&isrp=" + "rp";
            parent.document.getElementById(iframeid).src = url;
        ...
        function BillPreview() {
            ...
            var bearerId = $("#ContentPlaceHolder1_txtBearerIdInformation").val();
            ...
            if ($("#ContentPlaceHolder1_hfIsResumeBill").val() == "1" && $("#ContentPlaceHolder1_hfBillIdForInvoicePreview").val() != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../../../Common/WebMethodPage.aspx/UpdateRestauranBillReSettlement",
                    data: JSON.stringify({
        ...
        function AddMoreTable() {
            ...
            PageMethods.LoadAlreadyOccupiedTable(costCenterId, sourceId, OnOccupiedTableLoadSucceeded, OccupiedTableLoadFailed);
            return false;
        }
        ...
        function SearchAndAddItemToOrder(selectedItemId, selectedItemName) {
            ...
            PageMethods.SaveIndividualItemDetailInformation(isItemCanEditDelete, hfCostCenterIdVal, kotId, selectedItemId,
                selectedItemQty, OnSaveObjectSucceeded, OnSaveObjectFailed);
            return false;
        }
        ...
        function WaiterChangeDialogClose() {
    ...
    <asp:HiddenField ID="hfPaxQuantity" runat="server" Value="1"></asp:HiddenField>
                                ...
                                <div class="row">
                                    <div class="col-sm-4" style="padding-right: 5px;">
                                        <asp:TextBox ID="txtTPDiscountAmount" CssClass="form-control numkb quantity" TabIndex="1"
                                            runat="server" Text="0" onblur="CalculateDiscountAmount()"></asp:TextBox>
                                    </div>
            ...
            <div class="row">
                <div class="col-sm-11">
                    <div id="ltlMenuInformation" style="min-height: 81.5vh;">
                        <div style="height: 81.5vh; overflow: scroll;">
        ...
        <div class="col-sm-5">
            <div class="row" id="ItemSearchContainer">
                ...
                <div class="col-sm-3" style="margin-bottom: 5px; padding-left: 0px;">
                    <input type="text" id="txtItemQuantity" class="form-control" onfocus="this.select();" onkeydown="if (event.keyCode == 13) {SearchItemAdded(); return false;}" placeholder="Quantity" style="height: 30px;" />
                </div>
            </div>
    ...
    <div class="row pull-right" style="margin-top: 10px;">
        <div class="col-sm-12" style="margin-top: 3px; margin-bottom: 3px;">
            <input type="button" id="btnBackCostCenterSelection" class="TransactionalButton btn btn-primary"
                style="padding: 8px 5px; width: 155px; display: none;" value="Back To Cost Center" onclick="BackCostCenterSelection()" />
            <input type="button" id="btnClear" class="TransactionalButton btn btn-primary"
                style="padding: 8px 5px; width: 90px; display: none;" value="Clear" onclick="ClearOrderedItem()" />
            ...
            <input type="button" id="btnOrderSubmit" class="TransactionalButton btn btn-primary"
                style="padding: 8px 5px; width: 100px; display: none;" value="Order Submit" onclick="OrderSubmit()" />
            ...
            <input type="button" id="btnAddMoreTable" class="TransactionalButton btn btn-primary tblOrder"
                style="padding: 8px 5px; width: 130px; display: none;" value="Add More Table" onclick="AddMoreTable()" />
            <input type="button" id="btnBillSplit" class="TransactionalButton btn btn-primary"
                style="padding: 8px 5px; width: 90px; display: none;" value="Bill Split" onclick="BillSplit()" />
            ...
            <input type="button" id="btnBillHolpup" class="TransactionalButton btn btn-primary tknOrder"
                style="padding: 8px 5px; width: 90px; display: none;" value="Holdup" onclick="ValidateFormBeforeSettlement('holdup')" />
    ...
    <div id="WaiterChangeDialog" style="display: none;">
        <div class="form-horizontal">
            <div class="row no-gutters">
                <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-2">
                            <input type="button" id="btnRoomSearchOk" value="Ok" class="btn btn-primary" onclick="RoomSearchComplete()" />
                        </div>
                        <div class="col-sm-2">
                            <input type="button" id="btnRoomSearchCancel" value="Cancel" class="btn btn-primary" onclick="RoomSearchCancel()" />
                        </div>
                    </div>
                </div>
