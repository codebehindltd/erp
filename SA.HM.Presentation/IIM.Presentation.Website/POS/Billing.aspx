<%@ Page Title="" Language="C#" MasterPageFile="~/POS/RestaurantMM.Master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="HotelManagement.Presentation.Website.POS.Billing" %>
    ...
    <script type="text/javascript">
            ...
            $("#txtSerialAutoComplete").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        url: '../POS/Billing.aspx/SerialSearch',
        ...
        function PaymentCalculation(paymentAmount) {
            ...
            if (companyAmount != "0") {
                ...
                if (Math.round(parseFloat(paymentTotal)) > Math.round(parseFloat(grandTotal))) {
                    $("#txtCompanyPayment").val("");
            ...
            $("#txtDueRChnage").val(Math.round(toFixed(dueOrChangeAmount, 2)));
        }
