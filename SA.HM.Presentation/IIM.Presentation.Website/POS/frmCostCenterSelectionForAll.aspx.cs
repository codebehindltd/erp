...
{
    public partial class frmCostCenterSelectionForAll : System.Web.UI.Page
    {
            ...
            if (userInformationBO != null)
            {
                ...
                else
                {
                    ...
                    if (costCenterList.Count > 0)
                    {
                        ...
                        {
                            Response.Redirect("/POS/frmRetailPos.aspx?cid=" + vc[0].CostCenterId);
                        }
                    }
                    if (costCenterList.Count > 0)
                    {
                        ...
                        if (costCenterList.Count == 1 && vc.Count == 1)
                        {
                            Response.Redirect("/POS/Billing.aspx?cid=" + vc[0].CostCenterId);
                        }
                    }
                    if (costCenterList.Count > 0)
                    {
                        ...
                        if (costCenterList.Count == 1 && vc.Count == 1)
                        {
                            Response.Redirect("/POS/frmSOBilling.aspx?cid=" + vc[0].CostCenterId);
                        }
                    }
    ...
    public class TableOccupiedInfoBO
    {
        public string TableInfo { get; set; }
        public string OccupiedTableInfo { get; set; }
        public string OccupiedTableInfoByWaiter { get; set; }
        public bool IsWaiter { get; set; }
        public string OrderType { get; set; }
        public int OrderCostcenterId { get; set; }
