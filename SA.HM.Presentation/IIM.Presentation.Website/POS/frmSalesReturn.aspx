<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmSalesReturn.aspx.cs" EnableEventValidation="false" Inherits="HotelManagement.Presentation.Website.POS.frmSalesReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var ddlCostCenterTo = '<%=ddlCostCenterTo.ClientID%>'
            $('#' + ddlCostCenterTo).change(function () {
                LoadLocation($('#' + ddlCostCenterTo).val());
            });
        ...
        function OnSearchOutOrderForReturnSucceed(result) {
            ...
            $.each(result[0], function (count, gridObject) {
                ...
                tr += "<td style='display:none;'>" + gridObject.KotDetailId + "</td>";
            ...
            $("#ContentPlaceHolder1_hfLocationId").val(result[0][0].LocationIdFrom);
            LoadLocation(result[0][0].CostCenterIdFrom);

            $("#ContentPlaceHolder1_ddlCostCenterTo").val(result[0][0].CostCenterIdFrom);
            $("#ContentPlaceHolder1_lblConsumptionBy").text(result[0][0].CostCenter);
            $("#hfTransactionId").val(result[0][0].BillId);
        }
        ...
        function AddSerialForOutItemReturn(control) {
            ...
            var quantity = $(tr).find("td:eq(3)").text(); //$(tr).find("td:eq(3)").find("input").val();
        ...
        function SaveItemOutOrderReturn() {
            ...
            var returnId = 0, outOrderId = "0", returnType = "", receivedByDate = null, returnDetailsId = 0, isEdited = "0", productOutFor = '',
                ...
                quantity = 0, orderQuantity = 0, outDetailsId = 0, productType = '', itemName = '';
        ...
        function OnSearchPurchaseOrderSucceed(result) {
            ...
            $.each(result.GridData, function (count, gridObject) {
                ...
                tr += "<td style='width:15%;'>" + gridObject.ReturnDateString + "</td>";
                ...
                if (gridObject.Status != "Approved") {
                    ...
                    if (gridObject.IsCanApproved) {
                        ...
                        tr += "&nbsp;&nbsp;<img src='../Images/approved.png' onClick= \"javascript:return OutOrderApproval('Sales Return','" + 'Approved' + "', " + gridObject.ReturnId + "," + gridObject.TransactionId + ")\" alt='Approved'  title='Approved' border='0' />";
                    }
                }
        ...
        function OutOrderApproval(ReturnType, ApprovedStatus, ReturnId, TransactionId) {
            ...
            PageMethods.OutOrderApproval(ReturnType, ReturnId, 'Approved', TransactionId, OnApprovalSucceed, OnApprovalFailed);
        }
    ...
    <div id="myTabs">
        <ul id="tabPage" class="ui-style">
            <li id="A" runat="server" style="border: 1px solid #AAAAAA; border-bottom: none"><a
                href="#tab-1">Sales Item Return</a></li>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <asp:Label ID="Label5" runat="server" class="control-label" Text="Billing From"></asp:Label>
                                </div>
                                <div class="col-md-10">
