...
{
    public partial class frmPayFirstRestaurantBill : System.Web.UI.Page
    {
        ...
        public void LoadCostCenter()
        {
            ...
            var List = costCentreTabDA.GetUserWiseAllRestaurantTypeCostCentreTabInfo(userInformationBO.UserInfoId);
        ...
        private void LoadTemplateNo()
        {
            ...
            if (commonSetupBO1 != null)
            {
                ...
                {
                    hfCreditSale.Value = commonSetupBO1.SetupValue;
                }
            }
        ...
        [WebMethod]
        public static int[] SaveSettlement(string saveType, int kotId, int restaurantBillId, KotBillMasterBO billmasterBO, List<KotBillDetailBO> billdetailList, RestaurantBillBO restaurantBill, List<GuestBillPaymentBO> guestBillPayment)
        {
            UserInformationBO userInformationBO = new UserInformationBO();
            ...
            {
                int billId = restaurentBillDA.SaveRestaurantBillForAll(restaurantBill, restaurantBillDetailList, guestBillPayment, null, string.Empty, true, true, out billID);
            ...
            else
            {
                ...
                //status = restaurentBillDA.UpdateRestaurantBillForPayfirstPOS(restaurantBill, guestBillPayment, true);
        ...
        [WebMethod]
        public static int[] SavePreview(int kotId, int restaurantBillId, KotBillMasterBO billmasterBO, List<KotBillDetailBO> billdetailList, RestaurantBillBO restaurantBill)
        {
        ...
        public static string LoadSalesOrder(int companyId)
        {
            ...
            salesOrderList = purchaseOrderDA.GetSMSaleseOrderInfo(companyId);
            ...
            if (salesOrderList.Count > 0)
            {
                ...
                strTable += "<th style='display:none'></th><th align='center' scope='col' style='width: 5%;'><input id='CheckAll' type='checkbox' onclick='javascript: return CheckUncheckAll();'></th><th align='left' scope='col' style='width: 35%;'>SO Number</th><th align='left' scope='col' style='width: 25%;'>Invoice</th><th align='left' scope='col' style='width: 40%;'>Status</th>";
                strTable += "<tbody>";
                ...
                foreach (SMSalesOrderBO bo in salesOrderList)
                {
                    ...
                    strTable += "<td align='left' style='width: 35%;'>" + bo.SONumber + "</td>";
                    //strTable += "<td align='left' style='width: 20%;'>"+"" + "</td>";
                    strTable += "<td align='left' style='width: 20%; cursor:pointer;'><img src='../Images/ReportDocument.png' onClick='javascript:return GenerateInvoice(" + bo.SOrderId + ", " + bo.CompanyId + ")' alt='Invoice' border='0' /></td>";
