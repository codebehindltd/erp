<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true" CodeBehind="VMOverHeadName.aspx.cs" Inherits="HotelManagement.Presentation.Website.VehicleManagement.VMOverHeadName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function GridPaging(pageNumber, IsCurrentOrPreviousPage) {
            ...
            activeStat = activeStat == "0" ? true : false;

            PageMethods.SearchPaidServiceAndLoadGridInformation(serviceName, activeStat, gridRecordsCount, pageNumber, IsCurrentOrPreviousPage, OnLoadObjectSucceeded, OnLoadObjectFailed);
            return false;
        }
        function OnLoadObjectSucceeded(result) {
            ...
            $.each(result.GridData, function (count, gridObject) {
                ...
                tr += "<td align='left' style=\"width:20%; cursor:pointer;\">" + gridObject.Status + "</td>";
                ...
                tr += "<td align='right' style='width:25%;'> <a onclick=\"javascript:return PerformEditAction(" + gridObject.Id + ");\" title='Edit' href='javascript:void();'><img src='../Images/edit.png' alt='Edit'></a>"
                tr += "&nbsp;&nbsp;<a href='javascript:void();' onclick= 'DeleteOverHead(" + gridObject.Id + ")' ><img alt='Delete' src='../Images/delete.png' /></a>";
        ...
        function SaveOrUpdateVMOverHead() {
        ...
        function DuplicateCheckDynamicalySucceed(result) {
            ...
            if (result > 0) {
                ...
                var VMOverHeadBO = {
                    ...
                    AccountHeadId: NodeId,
                    Status: status,
                }
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: '../VehicleManagement/VMOverHeadName.aspx/SaveUpdateVMOverHeadInformation',

                    data: JSON.stringify({ VMOverHeadBO: VMOverHeadBO }),
                    dataType: "json",
                    success: function (data) {
                        GridPaging(1, 1);
                        PerformClearAction();
        ...
        function FillForm(Id) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: '../VehicleManagement/VMOverHeadName.aspx/FillForm',
                ...
                success: function (data) {
                    ...
                    $("#ContentPlaceHolder1_ddlIncomeAccountHead").val(data.d.AccountHeadId).trigger('change');
                    $("#ContentPlaceHolder1_txtDescription").val(data.d.Description);
                    $("#ContentPlaceHolder1_ddlActiveStat").val(data.d.Status == false ? "1" : "0");
        ...
        function DeleteOverHead(Id) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: '../VehicleManagement/VMOverHeadName.aspx/DeleteVMOverHead',
                data: "{'Id':'" + Id + "'}",
                dataType: "json",
                success: function (data) {
                    CommonHelper.AlertMessage(data.d.AlertMessage);
    ...
    <div id="CreateNewDialog" style="display: none; overflow: unset">
        <div class="form-horizontal">
            ...
            <div class="form-group" id="AccountHeadDiv" runat="server">
                <div class="col-md-2 ">
            ...
            <div class="row" style="padding-bottom: 0; padding-top: 10px;">
                <div class="col-md-12">
                    ...
                    <input id="btnSaveNContinue" type="button" value="Save & Continue" class="TransactionalButton btn btn-primary btn-sm"
                        onclick="javascript: return SaveOrUpdateVMOverHead();" />
                </div>
            </div>
        </div>
    </div>
