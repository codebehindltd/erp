...
{
    public partial class frmSupplierBillPayment : BasePage
    {
        ...
        [WebMethod]
        public static PMSupplierPaymentLedgerBO FillForm(int editId)
        {
            PMSupplierDA supplierDA = new PMSupplierDA();
            PMSupplierPaymentLedgerBO paymentBO = new PMSupplierPaymentLedgerBO();
            paymentBO = supplierDA.GetSupplierPaymentLedgerById(editId);
            if (paymentBO.SupplierPaymentId > 0)
            {
                CommonCurrencyDA commonCurrencyDA = new CommonCurrencyDA();
                CommonCurrencyBO commonCurrencyBO = new CommonCurrencyBO();
