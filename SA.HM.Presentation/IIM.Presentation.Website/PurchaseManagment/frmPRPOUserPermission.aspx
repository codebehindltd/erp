<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmPRPOUserPermission.aspx.cs" Inherits="HotelManagement.Presentation.Website.PurchaseManagment.frmPRPOUserPermission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ContentPlaceHolder1_ddlUserInfoId").select2({
                tags: "true",
                placeholder: "--- All ---",
                allowClear: true,
                width: "99.75%"
            ...
            $("[id=ContentPlaceHolder1_gvCostCenterInfo_ChkCreateRequisition]").on("click", function () {
                var topCheckBox = $(this);

                if ($(topCheckBox).is(":checked") == true) {
                    $("#ContentPlaceHolder1_gvCostCenterInfo tbody tr").find("td:eq(2) > span").find("input").prop("checked", true);
                }
                else {
                    $("#ContentPlaceHolder1_gvCostCenterInfo tbody tr").find("td:eq(2) > span").find("input").prop("checked", false);
                }
            });

            $("[id=ContentPlaceHolder1_gvCostCenterInfo_ChkCreatePurchase]").on("click", function () {
                var topCheckBox = $(this);

                if ($(topCheckBox).is(":checked") == true) {
                    $("#ContentPlaceHolder1_gvCostCenterInfo tbody tr").find("td:eq(3) > span").find("input").prop("checked", true);
                }
                else {
                    $("#ContentPlaceHolder1_gvCostCenterInfo tbody tr").find("td:eq(3) > span").find("input").prop("checked", false);
                }
            });
        ...
        function OnFillFormObjectSucceeded(result) {
            ...
            $("#<%=ddlUserInfoId.ClientID %>").val(result.EmpId);
        ...
        function PerformClearAction() {
            ...
            $("#<%=ddlUserInfoId.ClientID %>").val('---None---');
    ...
    <asp:HiddenField ID="hfUserInfoId" runat="server"></asp:HiddenField>
    <asp:HiddenField ID="hfMappingId" runat="server"></asp:HiddenField>
    <div id="myTabs">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <label for="UserName" class="control-label col-md-2">
                                User Name</label>
                            <div class="col-md-10">
                                <asp:DropDownList ID="ddlUserInfoId" runat="server" CssClass="form-control" TabIndex="1">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <%--<div class="form-group">
                                ...
                                <div>
                                    <asp:GridView ID="gvCostCenterInfo" Width="100%" runat="server" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Create/Update" ItemStyle-Width="5%">
                                                <HeaderTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Cost Center Information" ItemStyle-Width="50%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Requisition" ItemStyle-Width="15%">
                                                <HeaderTemplate>
                                                    <asp:CheckBox ID="ChkCreateRequisition" CssClass="ChkCreate" runat="server" /> Requisition
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkRequisition" CssClass="Chk_Create" runat="server" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Purchase Order" ItemStyle-Width="15%">
                                                <HeaderTemplate>
                                                    <asp:CheckBox ID="ChkCreatePurchase" CssClass="ChkCreate" runat="server" /> Purchase
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkPurchase" CssClass="Chk_Create" runat="server" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <label for="FromDate" class="control-label col-md-2">
                                From Date</label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtSFromDate" runat="server" CssClass="form-control" TabIndex="2"></asp:TextBox>
                            </div>
                            <%--<div class="col-md-2">
            ...
            <div id="SearchPanel" class="panel panel-default">
                ...
                <div class="panel-body">
                    <asp:GridView ID="gvBearerInformation" Width="100%" runat="server" AllowPaging="True"
                        AutoGenerateColumns="False" CellPadding="4" GridLines="None" AllowSorting="True"
                        ForeColor="#333333" PageSize="5" OnPageIndexChanging="gvBearerInformation_PageIndexChanging"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="IDNO" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblid" runat="server" Text='<%#Eval("MappingId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="UserName" HeaderText="User Name" ItemStyle-Width="25%">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <%--<asp:BoundField DataField="FromDate" DataFormatString="{0:MM/dd/yyyy hh:mm:ss tt}"
                                HeaderText="From Date" ItemStyle-Width="25%">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ToDate" HeaderText="To Date" DataFormatString="{0:MM/dd/yyyy hh:mm:ss tt}"
                                ItemStyle-Width="25%">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>--%>
                            <%--<asp:TemplateField HeaderText="From Date " ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:Label ID="lblFromDate" runat="server" Text='<%# GetStringFromDateTime(Convert.ToDateTime(Eval("FromDate")))%>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="To Date" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
