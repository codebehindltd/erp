...
{
    public partial class frmReportSupplierWisePurchaseInformation : BasePage
    {
        ...
        protected void btnGenarate_Click(object sender, EventArgs e)
        {
            ...
            {
                //purchaseInfo = purchaseDa.GetPurchaseInformation(FromDate, ToDate, supplierId, itemId, pONumber).ToList();
            }
