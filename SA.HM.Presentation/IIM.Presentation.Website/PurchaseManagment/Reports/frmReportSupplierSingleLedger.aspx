<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Innboard.Master" AutoEventWireup="true"
    CodeBehind="frmReportSupplierSingleLedger.aspx.cs" Inherits="HotelManagement.Presentation.Website.PurchaseManagment.Reports.frmReportSupplierSingleLedger" %>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <asp:DropDownList ID="ddlSupplierId" runat="server" CssClass="form-control" AutoPostBack="false">
                        </asp:DropDownList>
                    </div>
