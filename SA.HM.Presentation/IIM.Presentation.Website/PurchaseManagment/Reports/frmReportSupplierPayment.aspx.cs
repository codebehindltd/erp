...
{
    public partial class frmReportSupplierPayment : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.Session["SupplierBillPaymentIdList"] = string.Empty;
                    this.Session["SupplierBillPaymentIdList"] = Request.QueryString["PaymentIdList"];
                    Response.Redirect("/PurchaseManagment/Reports/frmReportSupplierPayment.aspx");
                }

                if (this.Session["SupplierBillPaymentIdList"] != null)
                {
                    ReportProcessing();
                }
            }
        ...
        private void ReportProcessing()
        {
            ...
            var reportPath = "";
            reportPath = Server.MapPath(@"~/PurchaseManagment/Reports/Rdlc/rptSupplierPayment.rdlc");
